...
public class Register extends IExpr implements ExprInterface {
	...
	public String AsmToC() { return "<customTag" + threadId + ">" + name + "</customTag>" /*+ "_" + threadId*/;}

	@Override
	public String AsmToCAssert() { return "<customAssertionTag" + threadId + ">" + name + "</customAssertionTag>" ;}

	/*
	@Override
	public String AsmToCAssert() { return "<customTag_x>" + name + "</customTag>";}
	 */
}

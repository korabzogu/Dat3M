...
atomic_store(&X0_0,2);//event.Local

atomic_store_explicit(&X1_0, &X0_0, memory_order_relaxed );//event.Store
...
atomic_store(&X0_1,2);//event.Local

atomic_store_explicit(&X1_1, &X0_1, memory_order_relaxed );//event.Store

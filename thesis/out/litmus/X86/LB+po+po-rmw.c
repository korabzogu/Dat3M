...
assert(!(((<customAssertionTag1>EBX</customAssertionTag> == 0) && (((<customAssertionTag0>EAX</customAssertionTag> == 0) && ((<customAssertionTag1>EAX</customAssertionTag> == 0) || (<customAssertionTag1>EAX</customAssertionTag> == 1))) || ((<customAssertionTag0>EAX</customAssertionTag> == 1) && (<customAssertionTag1>EAX</customAssertionTag> == 0))))));
return 0;
}

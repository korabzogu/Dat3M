...
assert(!(((<customAssertionTag1>EAX</customAssertionTag> == 0) && ((((<customAssertionTag0>EAX</customAssertionTag> == 0) && (x == 1)) && ((<customAssertionTag0>EBX</customAssertionTag> == 1) || (<customAssertionTag0>EBX</customAssertionTag> == 0))) || (((<customAssertionTag0>EAX</customAssertionTag> == 1) && (<customAssertionTag0>EBX</customAssertionTag> == 1)) && (x == 2))))));
return 0;
}

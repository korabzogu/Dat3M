...
assert(!(((((<customAssertionTag1>EAX</customAssertionTag> == 0) && (y == 1)) && ((<customAssertionTag1>EBX</customAssertionTag> == 0) || (<customAssertionTag1>EBX</customAssertionTag> == 1))) || (((<customAssertionTag1>EAX</customAssertionTag> == 1) && (<customAssertionTag1>EBX</customAssertionTag> == 1)) && (y == 2)))));
return 0;
}

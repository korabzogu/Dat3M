...
assert(!(((<customAssertionTag0>EAX</customAssertionTag> == 0) && (((<customAssertionTag1>EAX</customAssertionTag> == 0) && (((<customAssertionTag1>EBX</customAssertionTag> == 0) && (x == 2)) || ((<customAssertionTag1>EBX</customAssertionTag> == 2) && (x == 1)))) || (((<customAssertionTag1>EAX</customAssertionTag> == 1) && (<customAssertionTag1>EBX</customAssertionTag> == 2)) && (x == 1))))));
return 0;
}

...
assert(!((((<customAssertionTag0>EAX</customAssertionTag> == 0) && (((<customAssertionTag1>EAX</customAssertionTag> == 0) && (y == 1)) || ((<customAssertionTag1>EAX</customAssertionTag> == 1) && (y == 2)))) || (((<customAssertionTag0>EAX</customAssertionTag> == 1) && (<customAssertionTag1>EAX</customAssertionTag> == 0)) && (y == 1)))));
return 0;
}

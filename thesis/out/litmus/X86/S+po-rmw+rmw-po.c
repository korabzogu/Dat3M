...
assert(!((((((<customAssertionTag0>EAX</customAssertionTag> == 2) && (<customAssertionTag1>EAX</customAssertionTag> == 0)) && (y == 1)) && ((x == 2) || (x == 1))) || ((((<customAssertionTag0>EAX</customAssertionTag> == 0) && (<customAssertionTag1>EAX</customAssertionTag> == 1)) && (x == 1)) && (y == 2)))));
return 0;
}

...
ECX = atomic_load_explicit(&&mem2/* Address *//*com.dat3m.dartagnan.program.memory.Address*/, memory_order_relaxed);//event.Load
...
assert(((((EAX_2 == 1) && (EBX_2 == 2)) && (ECX_3 == 1)) && (EDX_3 == 0)));
return 0;
}

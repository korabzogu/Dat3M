...
<customTag0>top</customTag> = READ_ONCE(<customTag0>ToS</customTag>);

WRITE_ONCE(&<customTag0>Bnext</customTag>, <customTag0>top</customTag>);
...
<customTag1>top</customTag> = READ_ONCE(<customTag1>ToS</customTag>);
...
assert(!((<customAssertionTag1>out</customAssertionTag> == mem5) && (ToS == mem3)));
return 0;
}

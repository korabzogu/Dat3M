...
<customTag0>r1</customTag> = atomic_load_explicit(&<customTag0>x</customTag>, memory_order_relaxed);//event.Load
...
__VERIFIER_fence(Mb);
<customTag2>r1</customTag> = atomic_load_explicit(&<customTag2>x</customTag>, memory_order_relaxed);//event.Load

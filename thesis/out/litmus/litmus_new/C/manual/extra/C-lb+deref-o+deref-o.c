...
/*§Skip§*/
/*§Skip§*/
<customTag0>DUMMY_REG_3467</customTag> = atomic_load_explicit(&<customTag0>x</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3468</customTag> = atomic_load_explicit(&<customTag1>y</customTag>, memory_order_relaxed);//event.Load

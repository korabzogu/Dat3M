...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3480</customTag> = atomic_load_explicit(&<customTag1>x</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3480</customTag>;//event.Local

WRITE_ONCE(&<customTag1>c</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3480_1 = DUMMY_REG_3480;
c_1 = c;
x_1 = x;
r1_1 = r1;
}

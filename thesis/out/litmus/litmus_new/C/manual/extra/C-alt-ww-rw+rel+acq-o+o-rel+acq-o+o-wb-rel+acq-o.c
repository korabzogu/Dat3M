...
/*§Skip§*/
/*§Skip§*/
WRITE_ONCE(&<customTag2>y</customTag>, 2);
atomic_store_explicit(&<customTag2>z</customTag>, 1, memory_order_release );//event.Store
...
/*§Skip§*/
/*§Skip§*/
<customTag3>r2</customTag> = atomic_load_explicit(&<customTag3>z</customTag>, memory_order_acquire);//event.Load
...
atomic_store_explicit(&<customTag4>c</customTag>, 1, memory_order_release );//event.Store
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r3</customTag> = atomic_load_explicit(&<customTag5>c</customTag>, memory_order_acquire);//event.Load

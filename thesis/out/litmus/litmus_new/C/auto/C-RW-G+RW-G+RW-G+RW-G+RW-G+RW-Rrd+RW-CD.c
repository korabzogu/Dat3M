...
<customTag6>DUMMY_REG_2214</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2214</customTag>;//event.Local
...
r4_6 = r4;
y0_6 = y0;
DUMMY_REG_2214_6 = DUMMY_REG_2214;
x6_6 = x6;
r1_6 = r1;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_2941</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2941</customTag>;//event.Local
...
x1_1 = x1;
r1_1 = r1;
DUMMY_REG_2941_1 = DUMMY_REG_2941;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2942</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2942</customTag>;//event.Local

atomic_store_explicit(&<customTag3>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2942_3 = DUMMY_REG_2942;
r1_3 = r1;
}

...
<customTag5>DUMMY_REG_2835</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2835</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_5 = r4;
DUMMY_REG_2835_5 = DUMMY_REG_2835;
y0_5 = y0;
x5_5 = x5;
r1_5 = r1;
}

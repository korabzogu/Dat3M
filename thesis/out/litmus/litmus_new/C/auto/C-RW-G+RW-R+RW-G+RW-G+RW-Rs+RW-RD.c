...
__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_3399</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_3399</customTag>;//event.Local
...
r4_5 = r4;
y0_5 = y0;
DUMMY_REG_3399_5 = DUMMY_REG_3399;
x5_5 = x5;
r1_5 = r1;
}

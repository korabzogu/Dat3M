...
__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_2822</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2822</customTag>;//event.Local

WRITE_ONCE(&<customTag5>r1</customTag>, 1);
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2822_5 = DUMMY_REG_2822;
r4_5 = r4;
y0_5 = y0;
x5_5 = x5;
r1_5 = r1;

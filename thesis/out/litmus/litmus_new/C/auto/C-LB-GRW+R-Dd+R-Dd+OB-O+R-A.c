...
int r1_0;
int r3_1;
int DUMMY_REG_3161_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_3162_2;
int x2_2;
int r1_2;
int x3_3;
int x4_3;
...
<customTag1>DUMMY_REG_3161</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3161</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, <customTag1>r3</customTag>, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_3161_1 = DUMMY_REG_3161;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3162</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3162</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag2>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3162_2 = DUMMY_REG_3162;
x2_2 = x2;
r1_2 = r1;
}

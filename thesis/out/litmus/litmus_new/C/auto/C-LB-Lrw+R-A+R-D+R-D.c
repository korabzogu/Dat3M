...
int x2_1;
int r1_1;
int DUMMY_REG_3272_2;
int x2_2;
int x3_2;
int r1_2;
int DUMMY_REG_3273_3;
int x3_3;
int u0_3;
int r1_3;
atomic_int mem0;
...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_3272</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3272</customTag>;//event.Local

atomic_store_explicit(&<customTag2>x3</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3272_2 = DUMMY_REG_3272;
x2_2 = x2;
x3_2 = x3;
r1_2 = r1;
}
...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_3273</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3273</customTag>;//event.Local

atomic_store_explicit(&<customTag3>u0</customTag>, 1, memory_order_seq_cst /* TODO use usual C assign */ );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3273_3 = DUMMY_REG_3273;
x3_3 = x3;
u0_3 = u0;
r1_3 = r1;
}

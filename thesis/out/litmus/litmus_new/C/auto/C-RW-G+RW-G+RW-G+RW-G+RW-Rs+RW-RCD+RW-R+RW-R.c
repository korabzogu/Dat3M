...
__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_2522</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2522</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_5 = r4;
DUMMY_REG_2522_5 = DUMMY_REG_2522;
x5_5 = x5;
y6_5 = y6;
r1_5 = r1;
}

...
__VERIFIER_fence(Rcu_lock);
<customTag1>DUMMY_REG_3413</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3413</customTag>;//event.Local
...
x1_1 = x1;
y2_1 = y2;
DUMMY_REG_3413_1 = DUMMY_REG_3413;
r1_1 = r1;
}

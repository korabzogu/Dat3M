...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2341</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2341</customTag>;//event.Local

atomic_store_explicit(&<customTag2>x3</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2341_2 = DUMMY_REG_2341;
x2_2 = x2;
x3_2 = x3;
r1_2 = r1;
}

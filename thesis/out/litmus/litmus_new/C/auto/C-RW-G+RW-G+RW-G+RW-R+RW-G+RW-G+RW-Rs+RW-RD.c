...
__VERIFIER_fence(Rcu_lock);
<customTag7>DUMMY_REG_3381</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_3381</customTag>;//event.Local

WRITE_ONCE(&<customTag7>r1</customTag>, 1);
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
r4_7 = r4;
DUMMY_REG_3381_7 = DUMMY_REG_3381;
y0_7 = y0;
x7_7 = x7;
r1_7 = r1;
}

...
<customTag3>r2</customTag> = READ_ONCE(<customTag3>x0</customTag>);
...
WRITE_ONCE(&<customTag4>x1</customTag>, 1);
WRITE_ONCE(&<customTag4>x2</customTag>, 1);
WRITE_ONCE(&<customTag4>x3</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x0_4 = x0;
x1_4 = x1;
x2_4 = x2;

...
<customTag5>DUMMY_REG_3091</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_3091</customTag>;//event.Local
...
y0_5 = y0;
x5_5 = x5;
DUMMY_REG_3091_5 = DUMMY_REG_3091;
r1_5 = r1;
}

...
<customTag6>DUMMY_REG_2888</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2888</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2888_6 = DUMMY_REG_2888;
r4_6 = r4;
x6_6 = x6;
y7_6 = y7;
r1_6 = r1;

...
WRITE_ONCE(&<customTag6>x1</customTag>, 1);
WRITE_ONCE(&<customTag6>x2</customTag>, 1);
WRITE_ONCE(&<customTag6>x3</customTag>, 1);
WRITE_ONCE(&<customTag6>x4</customTag>, 1);
WRITE_ONCE(&<customTag6>x5</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x0_6 = x0;
x1_6 = x1;
x2_6 = x2;

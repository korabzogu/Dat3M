...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_2570</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2571</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_2572</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

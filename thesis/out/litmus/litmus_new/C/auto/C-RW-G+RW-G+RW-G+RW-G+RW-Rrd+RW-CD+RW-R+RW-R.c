...
/*§Skip§*/
/*§Skip§*/
<customTag4>r3</customTag> = <customTag4>x6</customTag>;//event.Local
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r4</customTag> = <customTag5>y6</customTag>;//event.Local

<customTag5>DUMMY_REG_2249</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2249</customTag>;//event.Local
...
x5_5 = x5;
y6_5 = y6;
DUMMY_REG_2249_5 = DUMMY_REG_2249;
r1_5 = r1;
}
...
WRITE_ONCE(&<customTag7>x0</customTag>, 1);
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
x0_7 = x0;
x7_7 = x7;

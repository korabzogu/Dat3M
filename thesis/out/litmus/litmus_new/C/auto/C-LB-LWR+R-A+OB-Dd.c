...
/*§Skip§*/
<customTag2>DUMMY_REG_2650</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2650</customTag>;//event.Local

<customTag2>r2</customTag> = READ_ONCE(<customTag2>r1</customTag>);

atomic_thread_fence(memory_order_seq_cst);
r2_2 = r2;
DUMMY_REG_2650_2 = DUMMY_REG_2650;
x2_2 = x2;
r1_2 = r1;
}
...
assert(!(((<customAssertionTag2>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == mem2)));
return 0;
}

...
__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_2964</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2964</customTag>;//event.Local
...
x5_5 = x5;
y6_5 = y6;
DUMMY_REG_2964_5 = DUMMY_REG_2964;
r1_5 = r1;
}

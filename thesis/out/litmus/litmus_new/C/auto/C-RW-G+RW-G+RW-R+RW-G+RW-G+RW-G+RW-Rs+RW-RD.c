...
__VERIFIER_fence(Rcu_lock);
<customTag7>DUMMY_REG_2889</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_2889</customTag>;//event.Local

WRITE_ONCE(&<customTag7>r1</customTag>, 1);
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2889_7 = DUMMY_REG_2889;
r4_7 = r4;
y0_7 = y0;
x7_7 = x7;
r1_7 = r1;

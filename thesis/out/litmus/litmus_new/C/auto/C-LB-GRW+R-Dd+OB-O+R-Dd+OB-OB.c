...
/*§Skip§*/
<customTag1>DUMMY_REG_2752</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2752</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag1>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_2752_1 = DUMMY_REG_2752;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2753</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2753</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag3>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2753_3 = DUMMY_REG_2753;
r1_3 = r1;
}

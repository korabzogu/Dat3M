...
<customTag3>DUMMY_REG_3244</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag4>DUMMY_REG_3245</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r1</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_acquire);//event.Load

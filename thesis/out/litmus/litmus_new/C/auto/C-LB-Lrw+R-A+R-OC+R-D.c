...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_3425</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3425</customTag>;//event.Local
...
u0_3 = u0;
r1_3 = r1;
DUMMY_REG_3425_3 = DUMMY_REG_3425;
}

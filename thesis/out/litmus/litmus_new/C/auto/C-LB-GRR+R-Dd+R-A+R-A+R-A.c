...
/*§Skip§*/
<customTag1>DUMMY_REG_2954</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2954</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2954_1 = DUMMY_REG_2954;
x1_1 = x1;
r1_1 = r1;
}

...
__VERIFIER_fence(Rcu_lock);
<customTag6>DUMMY_REG_2921</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2921</customTag>;//event.Local
...
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2921_6 = DUMMY_REG_2921;
r4_6 = r4;
x6_6 = x6;
y7_6 = y7;
r1_6 = r1;

...
int x3_1;
int r1_1;
int DUMMY_REG_2886_1;
int x2_2;
int DUMMY_REG_2887_2;
int r1_2;
int r4_3;
int x3_3;
int x4_3;
...
<customTag1>DUMMY_REG_2886</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2886</customTag>;//event.Local
...
x3_1 = x3;
r1_1 = r1;
DUMMY_REG_2886_1 = DUMMY_REG_2886;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2887</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2887</customTag>;//event.Local

atomic_store_explicit(&<customTag2>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
x2_2 = x2;
DUMMY_REG_2887_2 = DUMMY_REG_2887;
r1_2 = r1;
}
...
assert(!((((((<customAssertionTag5>r1</customAssertionTag> == 1) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == mem2)) && (<customAssertionTag2>r1</customAssertionTag> == mem5)) && (<customAssertionTag3>r1</customAssertionTag> == 1)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

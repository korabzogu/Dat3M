...
__VERIFIER_fence(Rcu_lock);
<customTag4>DUMMY_REG_3131</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load

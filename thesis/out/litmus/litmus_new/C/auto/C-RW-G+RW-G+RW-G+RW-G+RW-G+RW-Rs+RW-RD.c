...
__VERIFIER_fence(Rcu_lock);
<customTag6>DUMMY_REG_2466</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2466</customTag>;//event.Local
...
r4_6 = r4;
y0_6 = y0;
DUMMY_REG_2466_6 = DUMMY_REG_2466;
x6_6 = x6;
r1_6 = r1;
}

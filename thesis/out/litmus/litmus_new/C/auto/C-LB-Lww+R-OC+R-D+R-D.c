...
int r1_1;
int x2_2;
int DUMMY_REG_3323_2;
int x3_2;
int r1_2;
int x3_3;
int u0_3;
int DUMMY_REG_3324_3;
int r1_3;
atomic_int mem0;
atomic_int mem1;
atomic_int mem2;
...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_3323</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3323</customTag>;//event.Local

atomic_store_explicit(&<customTag2>x3</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
x2_2 = x2;
DUMMY_REG_3323_2 = DUMMY_REG_3323;
x3_2 = x3;
r1_2 = r1;
}
...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_3324</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3324</customTag>;//event.Local
...
x3_3 = x3;
u0_3 = u0;
DUMMY_REG_3324_3 = DUMMY_REG_3324;
r1_3 = r1;
}

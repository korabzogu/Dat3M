...
<customTag1>DUMMY_REG_2736</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
<customTag2>DUMMY_REG_2737</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
<customTag3>DUMMY_REG_2738</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag4>DUMMY_REG_2739</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load

...
/*§Skip§*/
<customTag3>DUMMY_REG_3086</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3086</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag3>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3086_3 = DUMMY_REG_3086;
x3_3 = x3;
r1_3 = r1;
}

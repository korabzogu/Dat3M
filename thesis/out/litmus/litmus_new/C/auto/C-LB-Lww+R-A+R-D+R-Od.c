...
<customTag2>DUMMY_REG_2900</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2900</customTag>;//event.Local

atomic_store_explicit(&<customTag2>x3</customTag>, <customTag2>r3</customTag>, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2900_2 = DUMMY_REG_2900;
r3_2 = r3;
x2_2 = x2;
x3_2 = x3;
u0_2 = u0;

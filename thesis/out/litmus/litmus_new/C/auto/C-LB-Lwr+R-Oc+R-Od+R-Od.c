...
assert(!((((<customAssertionTag3>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == mem2)) && (<customAssertionTag3>r1</customAssertionTag> == mem4)));
return 0;
}

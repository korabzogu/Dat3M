...
<customTag1>r2</customTag> = atomic_load_explicit(&<customTag1>r1</customTag>, memory_order_seq_cst /* TODO use usual C assign */);//event.Load
...
assert(!((<customAssertionTag1>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == mem2)));
return 0;
}

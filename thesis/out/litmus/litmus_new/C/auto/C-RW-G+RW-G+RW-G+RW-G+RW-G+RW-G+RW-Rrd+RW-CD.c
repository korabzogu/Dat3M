...
<customTag7>DUMMY_REG_2274</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_2274</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_7 = r4;
DUMMY_REG_2274_7 = DUMMY_REG_2274;
y0_7 = y0;
x7_7 = x7;
r1_7 = r1;
}

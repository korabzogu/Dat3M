...
__VERIFIER_fence(Rcu_lock);
<customTag7>DUMMY_REG_3012</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_3012</customTag>;//event.Local
...
r4_7 = r4;
y0_7 = y0;
DUMMY_REG_3012_7 = DUMMY_REG_3012;
x7_7 = x7;
r1_7 = r1;
}

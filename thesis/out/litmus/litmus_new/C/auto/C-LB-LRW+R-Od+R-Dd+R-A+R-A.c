...
/*§Skip§*/
<customTag2>DUMMY_REG_3386</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3386</customTag>;//event.Local

atomic_store_explicit(&<customTag2>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3386_2 = DUMMY_REG_3386;
x2_2 = x2;
r1_2 = r1;
}

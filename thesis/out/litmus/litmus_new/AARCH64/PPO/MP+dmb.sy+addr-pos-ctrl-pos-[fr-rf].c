...
<customTag1>DUMMY_REG_109</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_109</customTag>, memory_order_relaxed);//event.Load
...
assert(!((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 1)));
return 0;
}

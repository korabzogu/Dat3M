...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1891</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_1892</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1893</customTag>, memory_order_relaxed);//event.Load

...
DUMMY_REG_1210 = (mem0 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1210, X6, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1210_1 = DUMMY_REG_1210;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;
}

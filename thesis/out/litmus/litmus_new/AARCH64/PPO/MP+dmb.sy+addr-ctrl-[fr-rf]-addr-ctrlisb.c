...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_505</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_506</customTag>, memory_order_relaxed);//event.Load

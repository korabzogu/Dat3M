...
<customTag1>DUMMY_REG_216</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_216</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_217</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_217</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_217_1 = DUMMY_REG_217;
DUMMY_REG_216_1 = DUMMY_REG_216;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;

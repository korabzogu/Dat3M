...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1085</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1086</customTag>, memory_order_relaxed);//event.Load

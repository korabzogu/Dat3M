...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_564</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_565</customTag>, <customTag1>X9</customTag>, memory_order_relaxed );//event.Store

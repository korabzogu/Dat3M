...
<customTag1>DUMMY_REG_727</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_727</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_728</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_728</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_727_1 = DUMMY_REG_727;
DUMMY_REG_728_1 = DUMMY_REG_728;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;

...
<customTag1>DUMMY_REG_1951</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1951</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X6_1 = X6;
DUMMY_REG_1951_1 = DUMMY_REG_1951;
}

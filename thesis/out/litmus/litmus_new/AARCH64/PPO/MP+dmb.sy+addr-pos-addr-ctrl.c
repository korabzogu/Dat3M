...
<customTag1>DUMMY_REG_426</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_426</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_427</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_427</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_426_1 = DUMMY_REG_426;
DUMMY_REG_427_1 = DUMMY_REG_427;
X9_1 = X9;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;

...
int X1_1;
int X2_1;
int DUMMY_REG_2102_1;
int X3_1;
int DUMMY_REG_2101_1;
int X4_1;
int X5_1;
int X6_1;
int X7_1;
...
<customTag1>DUMMY_REG_2101</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2101</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_2102</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2102</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2102_1 = DUMMY_REG_2102;
X3_1 = X3;
DUMMY_REG_2101_1 = DUMMY_REG_2101;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!(((((((((x == 1) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

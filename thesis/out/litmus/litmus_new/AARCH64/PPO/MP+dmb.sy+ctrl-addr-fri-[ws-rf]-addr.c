...
int X11_1;
int X2_1;
int DUMMY_REG_1331_1;
int X3_1;
int DUMMY_REG_1332_1;
int X4_1;
int X5_1;
int X6_1;
int X7_1;
...
<customTag1>DUMMY_REG_1331</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1331</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1332</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1332</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1331_1 = DUMMY_REG_1331;
DUMMY_REG_1332_1 = DUMMY_REG_1332;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}

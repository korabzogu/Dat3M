...
DUMMY_REG_1077 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1077, X8, memory_order_relaxed );//event.Store
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1077_1 = DUMMY_REG_1077;
X2_1 = X2;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
...
assert(!((((((a == 1) && (x == 2)) && (y == 1)) && (X0_1 == 1)) && (X6_1 == 1)) && (X10_1 == 1)));
return 0;
}

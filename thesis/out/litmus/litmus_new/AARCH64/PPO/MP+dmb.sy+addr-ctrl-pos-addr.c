...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_617</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_618</customTag>, memory_order_relaxed);//event.Load

...
atomic_store_explicit(&DUMMY_REG_1851, X5, memory_order_relaxed );//event.Store
...
atomic_store_explicit(&DUMMY_REG_1852, X9, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_1851_1 = DUMMY_REG_1851;
X5_1 = X5;
X7_1 = X7;
DUMMY_REG_1852_1 = DUMMY_REG_1852;
}
...
assert(!((((((a == 1) && (x == 2)) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 1)) && (X11_1 == 1)));
return 0;
}

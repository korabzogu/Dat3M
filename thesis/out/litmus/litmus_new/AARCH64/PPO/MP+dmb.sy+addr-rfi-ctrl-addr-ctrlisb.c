...
atomic_store_explicit(&<customTag1>DUMMY_REG_254</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_255</customTag>, memory_order_relaxed);//event.Load

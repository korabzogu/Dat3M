...
atomic_store_explicit(&<customTag1>DUMMY_REG_310</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_311</customTag>, memory_order_relaxed);//event.Load

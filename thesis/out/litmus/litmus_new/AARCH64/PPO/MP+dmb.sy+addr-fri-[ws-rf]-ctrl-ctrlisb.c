...
<customTag1>DUMMY_REG_1493</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1493</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1493_1 = DUMMY_REG_1493;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 2)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_372</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_372</customTag>, memory_order_relaxed);//event.Load
...
assert(!(((((((x == 2) && (y == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 2)) && (<customAssertionTag1>X4</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

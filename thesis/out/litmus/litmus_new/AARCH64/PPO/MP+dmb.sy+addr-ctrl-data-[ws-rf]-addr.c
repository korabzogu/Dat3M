...
int X8_1;
int X9_1;
int DUMMY_REG_1339_1;
int X10_1;
int X12_1;
int X0_1;
int DUMMY_REG_1340_1;
int X1_1;
int X11_1;
int X2_1;
int X3_1;
...
<customTag1>DUMMY_REG_1339</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1339</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1340</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1340</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1339_1 = DUMMY_REG_1339;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1340_1 = DUMMY_REG_1340;
X11_1 = X11;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(!((((((b == 2) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 2)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_841</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_841</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_841_1 = DUMMY_REG_841;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;

...
<customTag1>DUMMY_REG_1024</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1024</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1024_1 = DUMMY_REG_1024;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;
}

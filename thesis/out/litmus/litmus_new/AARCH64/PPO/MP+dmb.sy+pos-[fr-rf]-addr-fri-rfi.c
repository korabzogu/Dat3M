...
<customTag1>DUMMY_REG_1377</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1377</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1377_1 = DUMMY_REG_1377;
X5_1 = X5;
X7_1 = X7;
}
...
assert(!(((((((x == 2) && (y == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 2)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

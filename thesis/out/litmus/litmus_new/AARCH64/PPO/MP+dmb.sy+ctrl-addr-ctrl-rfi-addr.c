...
int X12_1;
int X0_1;
int DUMMY_REG_2111_1;
int X1_1;
int X11_1;
int X2_1;
int X3_1;
int DUMMY_REG_2112_1;
int X4_1;
int X5_1;
int X6_1;
int X7_1;
...
<customTag1>DUMMY_REG_2111</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2111</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_2112</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2112</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_2111_1 = DUMMY_REG_2111;
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_2112_1 = DUMMY_REG_2112;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}
...
assert(!((((((b == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

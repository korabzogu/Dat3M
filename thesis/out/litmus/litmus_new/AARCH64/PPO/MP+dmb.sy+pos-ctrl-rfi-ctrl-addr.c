...
<customTag1>DUMMY_REG_1644</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1644</customTag>, memory_order_relaxed);//event.Load
...
X5_1 = X5;
X6_1 = X6;
DUMMY_REG_1644_1 = DUMMY_REG_1644;
}

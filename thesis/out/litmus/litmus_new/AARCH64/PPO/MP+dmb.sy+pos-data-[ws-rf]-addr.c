...
<customTag1>DUMMY_REG_969</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_969</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_969_1 = DUMMY_REG_969;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 2)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

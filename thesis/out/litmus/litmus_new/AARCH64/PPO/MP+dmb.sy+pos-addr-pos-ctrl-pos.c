...
<customTag1>DUMMY_REG_1003</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1003</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1003_1 = DUMMY_REG_1003;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!((((((x == 1) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

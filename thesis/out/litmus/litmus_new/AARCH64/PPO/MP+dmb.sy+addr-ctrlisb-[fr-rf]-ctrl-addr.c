...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1326</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1327</customTag>, memory_order_relaxed);//event.Load

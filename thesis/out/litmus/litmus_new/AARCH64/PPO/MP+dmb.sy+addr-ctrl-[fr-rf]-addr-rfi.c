...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_932</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_933</customTag>, <customTag1>X9</customTag>, memory_order_relaxed );//event.Store

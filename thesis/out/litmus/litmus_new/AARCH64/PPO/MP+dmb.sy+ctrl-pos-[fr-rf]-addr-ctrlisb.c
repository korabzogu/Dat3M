...
<customTag1>DUMMY_REG_1289</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1289</customTag>, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_1289_1 = DUMMY_REG_1289;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

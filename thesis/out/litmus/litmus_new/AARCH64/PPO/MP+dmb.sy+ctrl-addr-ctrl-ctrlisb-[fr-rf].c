...
<customTag1>DUMMY_REG_1044</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1044</customTag>, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1044_1 = DUMMY_REG_1044;
X11_1 = X11;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;

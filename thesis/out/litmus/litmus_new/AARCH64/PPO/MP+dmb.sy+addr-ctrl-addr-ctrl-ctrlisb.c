...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_597</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_598</customTag>, memory_order_relaxed);//event.Load

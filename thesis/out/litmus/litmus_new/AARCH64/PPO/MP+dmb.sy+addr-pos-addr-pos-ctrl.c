...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_282</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_283</customTag>, memory_order_relaxed);//event.Load

...
<customTag1>DUMMY_REG_344</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_344</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_344_1 = DUMMY_REG_344;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
...
assert(!(((((((a == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

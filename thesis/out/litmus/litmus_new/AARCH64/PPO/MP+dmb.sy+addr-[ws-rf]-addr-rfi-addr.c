...
int X12_1;
int X0_1;
int DUMMY_REG_1450_1;
int X1_1;
int DUMMY_REG_1451_1;
int X11_1;
int X2_1;
int DUMMY_REG_1452_1;
int X3_1;
int X4_1;
int X5_1;
int X6_1;
...
<customTag1>DUMMY_REG_1450</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1450</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1451</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1451</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1452</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1452</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1450_1 = DUMMY_REG_1450;
DUMMY_REG_1451_1 = DUMMY_REG_1451;
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_1452_1 = DUMMY_REG_1452;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
...
assert(!((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 2)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

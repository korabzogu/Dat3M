...
DUMMY_REG_748 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_748, X3, memory_order_relaxed );//event.Store
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 2)) && (X7_1 == 0)));
return 0;
}

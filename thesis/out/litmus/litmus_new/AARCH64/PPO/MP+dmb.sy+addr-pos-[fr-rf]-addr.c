...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_661</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_662</customTag>, memory_order_relaxed);//event.Load

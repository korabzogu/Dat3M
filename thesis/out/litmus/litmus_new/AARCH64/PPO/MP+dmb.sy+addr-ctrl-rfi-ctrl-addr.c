...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_429</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_430</customTag>, memory_order_relaxed);//event.Load

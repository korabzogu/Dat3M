...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1634</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1635</customTag>, memory_order_relaxed);//event.Load

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>X9</customTag>, memory_order_relaxed);//event.Load

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>X9</customTag>, memory_order_relaxed);//event.Load

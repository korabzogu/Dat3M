...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_408</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_409</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store

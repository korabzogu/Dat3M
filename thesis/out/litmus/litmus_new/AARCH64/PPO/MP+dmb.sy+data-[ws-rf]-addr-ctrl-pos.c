...
<customTag1>DUMMY_REG_2013</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2013</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2013_1 = DUMMY_REG_2013;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;
}
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 2)) && (<customAssertionTag1>X8</customAssertionTag> == 0)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

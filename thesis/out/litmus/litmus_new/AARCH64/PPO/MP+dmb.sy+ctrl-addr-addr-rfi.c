...
int X4_1;
int X5_1;
int DUMMY_REG_1521_1;
int X6_1;
int DUMMY_REG_1522_1;
int X7_1;
atomic_int mem0;
atomic_int mem1;
atomic_int mem2;
...
<customTag1>DUMMY_REG_1521</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1521</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1522</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1522</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1521_1 = DUMMY_REG_1521;
DUMMY_REG_1522_1 = DUMMY_REG_1522;
X7_1 = X7;
}

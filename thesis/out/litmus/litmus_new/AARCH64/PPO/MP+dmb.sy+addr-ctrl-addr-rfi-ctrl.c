...
<customTag1>DUMMY_REG_813</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_813</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_814</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_814</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_813_1 = DUMMY_REG_813;
DUMMY_REG_814_1 = DUMMY_REG_814;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;

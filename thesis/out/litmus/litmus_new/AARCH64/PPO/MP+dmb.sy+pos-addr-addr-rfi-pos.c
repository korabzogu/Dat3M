...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1034</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_1035</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store

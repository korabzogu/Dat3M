...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_572</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_573</customTag>, memory_order_relaxed);//event.Load

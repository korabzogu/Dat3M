...
<customTag1>DUMMY_REG_1358</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1358</customTag>, memory_order_relaxed);//event.Load
...
X5_1 = X5;
X7_1 = X7;
DUMMY_REG_1358_1 = DUMMY_REG_1358;
}

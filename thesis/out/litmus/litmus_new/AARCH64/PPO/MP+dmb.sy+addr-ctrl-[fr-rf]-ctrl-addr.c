...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_779</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_780</customTag>, memory_order_relaxed);//event.Load

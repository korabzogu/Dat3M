...
atomic_store_explicit(&<customTag1>DUMMY_REG_2041</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2042</customTag>, memory_order_relaxed);//event.Load

<customTag1>X9</customTag> = 1;//event.Local

atomic_store_explicit(&<customTag1>X8</customTag>, <customTag1>X9</customTag>, memory_order_relaxed );//event.Store

...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1491</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1492</customTag>, memory_order_relaxed);//event.Load

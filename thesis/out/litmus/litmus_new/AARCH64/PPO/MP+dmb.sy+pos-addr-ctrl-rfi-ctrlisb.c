...
<customTag1>DUMMY_REG_1422</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1422</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1422_1 = DUMMY_REG_1422;
X6_1 = X6;
}

...
<customTag1>DUMMY_REG_1642</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1642</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1642_1 = DUMMY_REG_1642;
X7_1 = X7;
}

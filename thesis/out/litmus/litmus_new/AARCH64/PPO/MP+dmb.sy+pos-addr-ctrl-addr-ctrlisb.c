...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1695</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1696</customTag>, memory_order_relaxed);//event.Load

...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1742</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>X6</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>X6</customTag>, memory_order_relaxed);//event.Load

...
int X11_1;
int X2_1;
int DUMMY_REG_1320_1;
int X3_1;
int DUMMY_REG_1321_1;
int X4_1;
int X5_1;
int X6_1;
int X7_1;
...
<customTag1>DUMMY_REG_1320</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1320</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1321</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1321</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_1320_1 = DUMMY_REG_1320;
X3_1 = X3;
DUMMY_REG_1321_1 = DUMMY_REG_1321;
X5_1 = X5;
X7_1 = X7;
}

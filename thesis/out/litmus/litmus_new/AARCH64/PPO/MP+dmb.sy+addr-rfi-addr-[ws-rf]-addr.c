...
<customTag1>DUMMY_REG_322</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_322</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_323</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_323</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_324</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_324</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_323_1 = DUMMY_REG_323;
DUMMY_REG_324_1 = DUMMY_REG_324;
DUMMY_REG_322_1 = DUMMY_REG_322;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
...
assert(!((((((((a == 2) && (x == 1)) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 2)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

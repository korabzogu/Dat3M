...
<customTag1>DUMMY_REG_1418</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1418</customTag>, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1418_1 = DUMMY_REG_1418;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;

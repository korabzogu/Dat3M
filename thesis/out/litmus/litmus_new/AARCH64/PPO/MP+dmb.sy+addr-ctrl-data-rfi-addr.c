...
int X8_1;
int X9_1;
int DUMMY_REG_1822_1;
int DUMMY_REG_1823_1;
int X10_1;
int X12_1;
int X0_1;
int X1_1;
...
<customTag1>DUMMY_REG_1822</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1822</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1823</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1823</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1822_1 = DUMMY_REG_1822;
DUMMY_REG_1823_1 = DUMMY_REG_1823;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;

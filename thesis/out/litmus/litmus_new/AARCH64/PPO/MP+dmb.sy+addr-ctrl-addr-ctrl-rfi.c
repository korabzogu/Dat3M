...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1653</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1654</customTag>, memory_order_relaxed);//event.Load

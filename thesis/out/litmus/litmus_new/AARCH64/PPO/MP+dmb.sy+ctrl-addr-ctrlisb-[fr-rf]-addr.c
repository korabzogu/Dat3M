...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_295</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_296</customTag>, memory_order_relaxed);//event.Load

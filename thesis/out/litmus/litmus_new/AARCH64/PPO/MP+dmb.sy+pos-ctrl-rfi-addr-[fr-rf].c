...
<customTag1>DUMMY_REG_1856</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1856</customTag>, memory_order_relaxed);//event.Load

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>X8</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1856_1 = DUMMY_REG_1856;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

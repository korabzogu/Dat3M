...
<customTag1>DUMMY_REG_1992</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1992</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1992_1 = DUMMY_REG_1992;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!((((((a == 2) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 2)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

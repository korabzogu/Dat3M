...
<customTag1>DUMMY_REG_2050</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2050</customTag>, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_2050_1 = DUMMY_REG_2050;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;

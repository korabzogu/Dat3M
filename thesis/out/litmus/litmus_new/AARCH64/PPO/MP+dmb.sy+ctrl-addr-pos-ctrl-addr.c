...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1612</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1613</customTag>, memory_order_relaxed);//event.Load

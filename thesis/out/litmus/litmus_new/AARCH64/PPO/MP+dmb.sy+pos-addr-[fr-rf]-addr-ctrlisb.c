...
<customTag1>DUMMY_REG_229</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_229</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_230</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_230</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_229_1 = DUMMY_REG_229;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_230_1 = DUMMY_REG_230;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
}

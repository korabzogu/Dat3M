...
<customTag1>DUMMY_REG_1288</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1288</customTag>, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1288_1 = DUMMY_REG_1288;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}

...
<customTag1>DUMMY_REG_1196</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1196</customTag>, memory_order_relaxed);//event.Load

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>X8</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1196_1 = DUMMY_REG_1196;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(!(((((((((x == 1) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 0)) && (<customAssertionTag1>X4</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_1384</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1384</customTag>, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X0_1 = X0;
DUMMY_REG_1384_1 = DUMMY_REG_1384;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

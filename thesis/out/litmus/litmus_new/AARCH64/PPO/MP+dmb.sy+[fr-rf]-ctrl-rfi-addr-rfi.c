...
DUMMY_REG_2057 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2057, X7, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_2057_1 = DUMMY_REG_2057;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!(((((((x == 2) && (y == 2)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 2)) && (X5_1 == 1)) && (X9_1 == 1)));
return 0;
}

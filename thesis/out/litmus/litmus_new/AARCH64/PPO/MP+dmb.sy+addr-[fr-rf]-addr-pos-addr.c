...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1948</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1949</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1950</customTag>, memory_order_relaxed);//event.Load

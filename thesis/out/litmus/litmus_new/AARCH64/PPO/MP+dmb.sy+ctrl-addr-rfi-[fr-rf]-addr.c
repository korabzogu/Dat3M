...
atomic_store_explicit(&<customTag1>DUMMY_REG_1870</customTag>, <customTag1>X5</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1871</customTag>, memory_order_relaxed);//event.Load

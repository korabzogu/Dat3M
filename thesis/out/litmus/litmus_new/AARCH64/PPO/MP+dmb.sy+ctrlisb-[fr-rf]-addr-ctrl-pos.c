...
<customTag1>DUMMY_REG_1808</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1808</customTag>, memory_order_relaxed);//event.Load
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1808_1 = DUMMY_REG_1808;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;

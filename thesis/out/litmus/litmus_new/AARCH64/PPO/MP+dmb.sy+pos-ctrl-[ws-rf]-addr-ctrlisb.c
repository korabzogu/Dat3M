...
<customTag1>DUMMY_REG_1089</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1089</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1089_1 = DUMMY_REG_1089;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;

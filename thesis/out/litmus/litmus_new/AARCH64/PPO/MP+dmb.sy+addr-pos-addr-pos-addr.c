...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1472</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1473</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1474</customTag>, memory_order_relaxed);//event.Load

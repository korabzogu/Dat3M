...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>X6</customTag>, memory_order_acquire);//event.Load
...
assert(!((((((x == 1) && (y == 2)) && (<customAssertionTag0>X5</customAssertionTag> == 2)) && (<customAssertionTag0>X2</customAssertionTag> == 0)) && (<customAssertionTag1>X2</customAssertionTag> == 2)) && (<customAssertionTag1>X4</customAssertionTag> == 0)));
return 0;
}

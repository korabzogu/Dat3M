...
<customTag1>DUMMY_REG_2176</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2176</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
DUMMY_REG_2176_1 = DUMMY_REG_2176;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;

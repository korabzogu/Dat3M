...
<customTag1>DUMMY_REG_2157</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2157</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2157_1 = DUMMY_REG_2157;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;
}

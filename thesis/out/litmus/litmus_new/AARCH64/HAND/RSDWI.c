...
atomic_store_explicit(&<customTag1>X4</customTag>, <customTag1>X9</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_98</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_99</customTag>, memory_order_relaxed);//event.Load

...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>X2</customTag>, memory_order_relaxed);//event.Load

atomic_store_explicit(&<customTag1>X2</customTag>, <customTag1>X0</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_74</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>X14</customTag>, <customTag1>X13</customTag>, memory_order_relaxed );//event.Store

...
int X3_0;
int X8_1;
int DUMMY_REG_2151_1;
int DUMMY_REG_2150_1;
int X0_1;
int X1_1;
int X2_1;
int X3_1;
...
<customTag1>DUMMY_REG_2150</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_2150</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_2151</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2151</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2151_1 = DUMMY_REG_2151;
DUMMY_REG_2150_1 = DUMMY_REG_2150;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(!(((<customAssertionTag1>X0</customAssertionTag> == 1) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

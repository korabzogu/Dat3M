...
<customTag0>x</customTag> = <customTag0>r4</customTag>;
...
assert(((<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */) && (<customAssertionTag1>r2</customAssertionTag> == 0)));
return 0;
}

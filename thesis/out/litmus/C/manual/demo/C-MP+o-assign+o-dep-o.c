...
atomic_store_explicit(&<customTag0>x</customTag>, <customTag0>r4</customTag>, memory_order_release );//event.Store
...
assert(!((<customAssertionTag1>r1</customAssertionTag> == mem2) && (<customAssertionTag1>r2</customAssertionTag> == 0)));
return 0;
}

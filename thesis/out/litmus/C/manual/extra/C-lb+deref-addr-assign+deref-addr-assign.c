...
/*§Skip§*/
/*§Skip§*/
<customTag0>DUMMY_REG_3485</customTag> = atomic_load_explicit(&<customTag0>x</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3486</customTag> = atomic_load_explicit(&<customTag1>y</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

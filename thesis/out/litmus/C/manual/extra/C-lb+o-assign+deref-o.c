...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3472</customTag> = atomic_load_explicit(&<customTag1>y</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r3</customTag> = <customTag1>DUMMY_REG_3472</customTag>;//event.Local

<customTag1>x</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_3472_1 = DUMMY_REG_3472;
x_1 = x;
y_1 = y;
}

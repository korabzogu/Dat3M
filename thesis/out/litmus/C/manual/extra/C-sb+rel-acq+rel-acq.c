...
<customTag0>r2</customTag> = atomic_load_explicit(&<customTag0>y</customTag>, memory_order_acquire);//event.Load
...
<customTag1>r4</customTag> = atomic_load_explicit(&<customTag1>x</customTag>, memory_order_acquire);//event.Load

...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3469</customTag> = atomic_load_explicit(&<customTag1>y</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_3470</customTag> = atomic_load_explicit(&<customTag2>z</customTag>, memory_order_relaxed);//event.Load
...
WRITE_ONCE(&<customTag2>r6</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
r5_2 = r5;
r6_2 = r6;

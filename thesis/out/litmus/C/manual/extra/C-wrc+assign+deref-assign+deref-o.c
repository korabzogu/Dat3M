...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3463</customTag> = atomic_load_explicit(&<customTag1>y</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_3464</customTag> = atomic_load_explicit(&<customTag2>x</customTag>, memory_order_relaxed);//event.Load

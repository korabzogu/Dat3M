...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3471</customTag> = atomic_load_explicit(&<customTag1>y</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r3</customTag> = <customTag1>DUMMY_REG_3471</customTag>;//event.Local
...
r3_1 = r3;
r4_1 = r4;
DUMMY_REG_3471_1 = DUMMY_REG_3471;
r9_1 = r9;
x_1 = x;
y_1 = y;
}

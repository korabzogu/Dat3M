...
/*§Skip§*/
/*§Skip§*/
<customTag4>r3</customTag> = atomic_load_explicit(&<customTag4>a</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load

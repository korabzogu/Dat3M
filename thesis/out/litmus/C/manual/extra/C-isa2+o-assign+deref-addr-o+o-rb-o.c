...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3475</customTag> = atomic_load_explicit(&<customTag1>x</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

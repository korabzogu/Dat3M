...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_3477</customTag> = atomic_load_explicit(&<customTag1>x</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3477</customTag>;//event.Local
...
a_1 = a;
x_1 = x;
DUMMY_REG_3477_1 = DUMMY_REG_3477;
r1_1 = r1;
}

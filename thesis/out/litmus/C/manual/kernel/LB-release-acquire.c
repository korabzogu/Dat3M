...
<customTag0>r1</customTag> = atomic_load_explicit(&<customTag0>u</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load
...
<customTag1>v</customTag> = 1;

<customTag1>r1</customTag> = atomic_load_explicit(&<customTag1>v</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load
...
assert(((<customAssertionTag0>r0</customAssertionTag> == 1) && (<customAssertionTag1>r0</customAssertionTag> == 1)));
return 0;
}

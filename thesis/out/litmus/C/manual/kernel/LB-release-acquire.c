...
<customTag0>r1</customTag> = atomic_load_explicit(&<customTag0>u</customTag>, memory_order_acquire);//event.Load
...
<customTag1>r1</customTag> = atomic_load_explicit(&<customTag1>v</customTag>, memory_order_acquire);//event.Load

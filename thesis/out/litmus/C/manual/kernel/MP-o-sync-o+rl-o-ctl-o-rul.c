...
/*§Skip§*/
__VERIFIER_HARDWARE(NULL);
<customTag1>r0</customTag> = atomic_load_explicit(&<customTag1>b</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

if(<customTag1>r0</customTag>) {

...
atomic_store_explicit(&<customTag0>x1</customTag>, 2, memory_order_release );//event.Store
...
<customTag2>r2</customTag> = atomic_load_explicit(&<customTag2>x1</customTag>, memory_order_acquire);//event.Load

<customTag2>r3</customTag> = READ_ONCE(<customTag2>x0</customTag>);

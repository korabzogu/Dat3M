...
<customTag3>r1</customTag> = atomic_load_explicit(&<customTag3>x0</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
assert(((((<customAssertionTag0>r1</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == 0)) && (<customAssertionTag2>r1</customAssertionTag> == 0)) && (<customAssertionTag3>r1</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>r1</customTag> = atomic_load_explicit(&<customTag1>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
<customTag2>x2</customTag> = 1;

<customTag2>r1</customTag> = atomic_load_explicit(&<customTag2>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

<customTag2>sl</customTag> = 0;
...
<customTag3>x3</customTag> = 1;

<customTag3>r1</customTag> = atomic_load_explicit(&<customTag3>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

<customTag3>sl</customTag> = 0;
...
<customTag4>x4</customTag> = 1;

<customTag4>r1</customTag> = atomic_load_explicit(&<customTag4>x0</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

<customTag4>sl</customTag> = 0;
...
assert((((((<customAssertionTag0>r1</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == 0)) && (<customAssertionTag2>r1</customAssertionTag> == 0)) && (<customAssertionTag3>r1</customAssertionTag> == 0)) && (<customAssertionTag4>r1</customAssertionTag> == 0)));
return 0;
}

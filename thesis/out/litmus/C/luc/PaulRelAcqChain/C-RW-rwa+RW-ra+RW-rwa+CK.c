...
<customTag3>r2</customTag> = atomic_load_explicit(&<customTag3>y</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
assert(((((<customAssertionTag1>r1</customAssertionTag> == 1) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r2</customAssertionTag> == 0)) && (<customAssertionTag3>r1</customAssertionTag> == 1)));
return 0;
}

...
<customTag1>top</customTag> = atomic_load_explicit(&<customTag1>ToS</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

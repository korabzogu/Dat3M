...
<customTag0>t</customTag> = atomic_load_explicit(&<customTag0>x91</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load

...
<customTag2>DUMMY_REG_2842</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2842</customTag>;//event.Local
...
y3_2 = y3;
r1_2 = r1;
DUMMY_REG_2842_2 = DUMMY_REG_2842;
}

...
int r1_0;
int x1_1;
int DUMMY_REG_3404_1;
int r1_1;
int DUMMY_REG_3405_2;
int r4_2;
int x2_2;
int u0_2;
int r1_2;
...
/*§Skip§*/
<customTag1>DUMMY_REG_3404</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3404</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_3404_1 = DUMMY_REG_3404;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_3405</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3405</customTag>;//event.Local

<customTag2>r4</customTag> = (<customTag2>r1</customTag>)==(<customTag2>r4</customTag>);//event.Local

if(<customTag2>r4</customTag>) {
WRITE_ONCE(&<customTag2>u0</customTag>, <customTag2>r1</customTag>);
} else {}
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3405_2 = DUMMY_REG_3405;
r4_2 = r4;
x2_2 = x2;
u0_2 = u0;
r1_2 = r1;
...
assert(!(((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == mem3)) && (<customAssertionTag2>r1</customAssertionTag> == 1)));
return 0;
}

...
<customTag6>DUMMY_REG_2618</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2618</customTag>;//event.Local

WRITE_ONCE(&<customTag6>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
r4_6 = r4;
DUMMY_REG_2618_6 = DUMMY_REG_2618;
x6_6 = x6;
y7_6 = y7;
r1_6 = r1;
}

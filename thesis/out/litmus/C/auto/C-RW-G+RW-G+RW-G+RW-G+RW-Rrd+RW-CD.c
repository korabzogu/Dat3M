...
<customTag5>DUMMY_REG_2863</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2863</customTag>;//event.Local
...
r4_5 = r4;
y0_5 = y0;
DUMMY_REG_2863_5 = DUMMY_REG_2863;
x5_5 = x5;
r1_5 = r1;
}

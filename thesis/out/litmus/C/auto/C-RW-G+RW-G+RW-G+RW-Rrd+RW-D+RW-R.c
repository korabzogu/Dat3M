...
<customTag4>DUMMY_REG_2247</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2247</customTag>;//event.Local
...
x4_4 = x4;
y5_4 = y5;
DUMMY_REG_2247_4 = DUMMY_REG_2247;
r1_4 = r1;
}

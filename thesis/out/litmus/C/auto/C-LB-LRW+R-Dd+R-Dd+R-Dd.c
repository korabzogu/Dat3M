...
int r1_0;
int r3_1;
int DUMMY_REG_2536_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_2537_2;
int r3_2;
int x2_2;
int u0_2;
int r1_2;
int DUMMY_REG_2538_3;
int x3_3;
int r1_3;
...
<customTag1>DUMMY_REG_2536</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2536</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2536_1 = DUMMY_REG_2536;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2537</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2537</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2537_2 = DUMMY_REG_2537;
r3_2 = r3;
x2_2 = x2;
u0_2 = u0;
r1_2 = r1;
...
/*§Skip§*/
<customTag3>DUMMY_REG_2538</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2538</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2538_3 = DUMMY_REG_2538;
x3_3 = x3;
r1_3 = r1;
}

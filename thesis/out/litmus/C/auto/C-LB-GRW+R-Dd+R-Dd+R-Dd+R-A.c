...
int r1_0;
int r3_1;
int DUMMY_REG_2789_1;
int x1_1;
int x3_1;
int r1_1;
int r3_2;
int DUMMY_REG_2790_2;
int x2_2;
int x4_2;
int r1_2;
int DUMMY_REG_2791_3;
int x3_3;
int r1_3;
int v0_4;
int x4_4;
...
<customTag1>DUMMY_REG_2789</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2789</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, <customTag1>r3</customTag>, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2789_1 = DUMMY_REG_2789;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2790</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2790</customTag>;//event.Local

atomic_store_explicit(&<customTag2>r1</customTag>, <customTag2>r3</customTag>, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_2790_2 = DUMMY_REG_2790;
x2_2 = x2;
x4_2 = x4;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2791</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2791</customTag>;//event.Local

atomic_store_explicit(&<customTag3>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2791_3 = DUMMY_REG_2791;
x3_3 = x3;
r1_3 = r1;
}
...
assert(!((((((<customAssertionTag5>r1</customAssertionTag> == 1) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == mem2)) && (<customAssertionTag2>r1</customAssertionTag> == mem4)) && (<customAssertionTag3>r1</customAssertionTag> == mem7)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_2531</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2531</customTag>;//event.Local

<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_2531_1 = DUMMY_REG_2531;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2532</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2532</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2532_3 = DUMMY_REG_2532;
r1_3 = r1;
}
...
assert(((((((<customAssertionTag5>r1</customAssertionTag> == 1) && (<customAssertionTag5>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == &mem5/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == &mem6/* Address */)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

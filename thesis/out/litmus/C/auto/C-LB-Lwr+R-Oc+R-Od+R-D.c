...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_2948</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2948</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r2_3 = r2;
DUMMY_REG_2948_3 = DUMMY_REG_2948;
x3_3 = x3;
u0_3 = u0;
r1_3 = r1;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_2681</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2681</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag1>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2681_1 = DUMMY_REG_2681;
x1_1 = x1;
r1_1 = r1;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_3239</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3239</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_3239_1 = DUMMY_REG_3239;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_3240</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3240</customTag>;//event.Local

atomic_store_explicit(&<customTag3>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3240_3 = DUMMY_REG_3240;
x3_3 = x3;
r1_3 = r1;
}
...
assert(!(((((<customAssertionTag4>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == mem5)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == mem6)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

...
/*§Skip§*/
/*§Skip§*/
WRITE_ONCE(&<customTag8>x0</customTag>, 1);
WRITE_ONCE(&<customTag8>x1</customTag>, 1);
WRITE_ONCE(&<customTag8>x2</customTag>, 1);
WRITE_ONCE(&<customTag8>x3</customTag>, 1);
WRITE_ONCE(&<customTag8>x4</customTag>, 1);
WRITE_ONCE(&<customTag8>x5</customTag>, 1);
WRITE_ONCE(&<customTag8>x6</customTag>, 1);
WRITE_ONCE(&<customTag8>x7</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x0_8 = x0;
x1_8 = x1;
x2_8 = x2;

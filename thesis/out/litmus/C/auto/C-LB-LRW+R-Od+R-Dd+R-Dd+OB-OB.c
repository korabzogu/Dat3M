...
int r1_1;
int r3_2;
int DUMMY_REG_2452_2;
int x2_2;
int x4_2;
int r1_2;
int x3_3;
int DUMMY_REG_2453_3;
int r1_3;
int u0_4;
int x4_4;
int r1_4;
...
<customTag2>DUMMY_REG_2452</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2452</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_2452_2 = DUMMY_REG_2452;
x2_2 = x2;
x4_2 = x4;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2453</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2453</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2453_3 = DUMMY_REG_2453;
r1_3 = r1;
}

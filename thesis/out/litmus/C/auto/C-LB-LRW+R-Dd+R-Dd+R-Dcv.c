...
int r1_0;
int r3_1;
int DUMMY_REG_2892_1;
int x1_1;
int x3_1;
int r1_1;
int x2_2;
int DUMMY_REG_2893_2;
int r1_2;
int r4_3;
int DUMMY_REG_2894_3;
int x3_3;
int u0_3;
int r1_3;
...
<customTag1>DUMMY_REG_2892</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2892</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2892_1 = DUMMY_REG_2892;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2893</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2893</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x2_2 = x2;
DUMMY_REG_2893_2 = DUMMY_REG_2893;
r1_2 = r1;
}
...
<customTag3>DUMMY_REG_2894</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2894</customTag>;//event.Local

<customTag3>r4</customTag> = (<customTag3>r1</customTag>)==(<customTag3>r4</customTag>);//event.Local

if(<customTag3>r4</customTag>) {
<customTag3>u0</customTag> = <customTag3>r1</customTag>;
...
atomic_thread_fence(memory_order_seq_cst);
r4_3 = r4;
DUMMY_REG_2894_3 = DUMMY_REG_2894;
x3_3 = x3;
u0_3 = u0;
r1_3 = r1;
}
...
assert(((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem5/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == 1)));
return 0;
}

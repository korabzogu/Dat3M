...
/*§Skip§*/
<customTag1>DUMMY_REG_3090</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3090</customTag>;//event.Local
...
x1_1 = x1;
r1_1 = r1;
DUMMY_REG_3090_1 = DUMMY_REG_3090;
}
...
<customTag2>r4</customTag> = atomic_load_explicit(&<customTag2>z2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
int z2 = atomic_load_explicit(&mem4, memory_order_relaxed);

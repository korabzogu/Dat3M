...
__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_2217</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2217</customTag>;//event.Local
...
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2217_5 = DUMMY_REG_2217;
r4_5 = r4;
x5_5 = x5;
y6_5 = y6;
r1_5 = r1;

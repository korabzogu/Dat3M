...
<customTag2>DUMMY_REG_3327</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3327</customTag>;//event.Local
...
y0_2 = y0;
x2_2 = x2;
DUMMY_REG_3327_2 = DUMMY_REG_3327;
r1_2 = r1;
}

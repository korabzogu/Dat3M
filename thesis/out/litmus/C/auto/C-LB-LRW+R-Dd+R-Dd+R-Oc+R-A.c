...
int r1_0;
int r3_1;
int DUMMY_REG_3053_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_3054_2;
int x2_2;
int r1_2;
int r4_3;
int x3_3;
...
<customTag1>DUMMY_REG_3053</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3053</customTag>;//event.Local

atomic_store_explicit(&<customTag1>r1</customTag>, <customTag1>r3</customTag>, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_3053_1 = DUMMY_REG_3053;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3054</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3054</customTag>;//event.Local

atomic_store_explicit(&<customTag2>r1</customTag>, 1, memory_order_release );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3054_2 = DUMMY_REG_3054;
x2_2 = x2;
r1_2 = r1;
}

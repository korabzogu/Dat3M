...
<customTag4>r2</customTag> = atomic_load_explicit(&<customTag4>x0</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
assert((((((<customAssertionTag4>r2</customAssertionTag> == 0) && (<customAssertionTag0>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r2</customAssertionTag> == 0)) && (<customAssertionTag2>r2</customAssertionTag> == 0)) && (<customAssertionTag3>r2</customAssertionTag> == 0)));
return 0;
}

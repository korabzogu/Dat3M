...
/*§Skip§*/
/*§Skip§*/
<customTag4>r3</customTag> = <customTag4>x0</customTag>;//event.Local

__VERIFIER_fence(Rcu_lock);
<customTag4>r1</customTag> = READ_ONCE(<customTag4>x4</customTag>);

atomic_store_explicit(&<customTag4>x5</customTag>, <customTag4>r3</customTag>, memory_order_release );//event.Store
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r4</customTag> = <customTag5>y0</customTag>;//event.Local

__VERIFIER_fence(Rcu_lock);
<customTag5>DUMMY_REG_2514</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2514</customTag>;//event.Local
...
__VERIFIER_fence(Rcu_unlock);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2514_5 = DUMMY_REG_2514;
r4_5 = r4;
y0_5 = y0;
x5_5 = x5;
r1_5 = r1;
...
int x5 = atomic_load_explicit(&mem0, memory_order_relaxed);
assert(!((((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == 1)) && (<customAssertionTag4>r1</customAssertionTag> == 1)) && (<customAssertionTag5>r1</customAssertionTag> == mem2)));
return 0;
}

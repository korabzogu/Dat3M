...
__VERIFIER_fence(Mb);
<customTag1>r2</customTag> = READ_ONCE(<customTag1>v0</customTag>);
...
assert(!(((<customAssertionTag1>r2</customAssertionTag> == 0) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == 1)));
return 0;
}

...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2424</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2424</customTag>;//event.Local
...
x3_2 = x3;
r1_2 = r1;
DUMMY_REG_2424_2 = DUMMY_REG_2424;
}

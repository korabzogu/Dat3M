...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_3095</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3095</customTag>;//event.Local

atomic_store_explicit(&<customTag3>u0</customTag>, 1, memory_order_seq_cst /* TODO use usual C assign */ );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3095_3 = DUMMY_REG_3095;
x3_3 = x3;
u0_3 = u0;
r1_3 = r1;
}

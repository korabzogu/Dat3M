...
int r1_2;
int r3_3;
int DUMMY_REG_3244_3;
int x3_3;
int x5_3;
int r1_3;
int DUMMY_REG_3245_4;
int x4_4;
int r1_4;
int u0_5;
int x5_5;
...
<customTag3>DUMMY_REG_3244</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3244</customTag>;//event.Local

<customTag3>r1</customTag> = <customTag3>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_3 = r3;
DUMMY_REG_3244_3 = DUMMY_REG_3244;
x3_3 = x3;
x5_3 = x5;
r1_3 = r1;
}
...
/*§Skip§*/
<customTag4>DUMMY_REG_3245</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_3245</customTag>;//event.Local

<customTag4>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3245_4 = DUMMY_REG_3245;
x4_4 = x4;
r1_4 = r1;
}
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r1</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load

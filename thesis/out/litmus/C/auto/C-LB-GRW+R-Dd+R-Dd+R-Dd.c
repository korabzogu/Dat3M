...
int x1_1;
int x3_1;
int DUMMY_REG_2662_1;
int r1_1;
int r3_2;
int x2_2;
int v0_2;
int DUMMY_REG_2663_2;
int r1_2;
int x3_3;
int DUMMY_REG_2664_3;
int r1_3;
int v0_4;
int u0_4;
int r1_4;
...
<customTag1>DUMMY_REG_2662</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2662</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_2662_1 = DUMMY_REG_2662;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2663</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2663</customTag>;//event.Local
...
x2_2 = x2;
v0_2 = v0;
DUMMY_REG_2663_2 = DUMMY_REG_2663;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2664</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2664</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2664_3 = DUMMY_REG_2664;
r1_3 = r1;
}
...
assert((((((<customAssertionTag4>r1</customAssertionTag> == 1) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == &mem7/* Address */)));
return 0;
}

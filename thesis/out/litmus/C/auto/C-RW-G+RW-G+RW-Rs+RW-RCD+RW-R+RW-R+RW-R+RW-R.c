...
__VERIFIER_HARDWARE(NULL);
<customTag3>DUMMY_REG_3257</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3257</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_3 = r4;
DUMMY_REG_3257_3 = DUMMY_REG_3257;
x3_3 = x3;
y4_3 = y4;
r1_3 = r1;
}

...
<customTag2>DUMMY_REG_2463</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
<customTag3>DUMMY_REG_2464</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag4>DUMMY_REG_2465</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load

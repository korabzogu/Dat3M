...
int x3_3;
int u0_3;
int DUMMY_REG_2464_3;
int r1_3;
int DUMMY_REG_2465_4;
int x4_4;
int r1_4;
...
<customTag2>DUMMY_REG_2463</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2463</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_2463_2 = DUMMY_REG_2463;
x2_2 = x2;
x4_2 = x4;
r1_2 = r1;
}
...
<customTag3>DUMMY_REG_2464</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2464</customTag>;//event.Local
...
x3_3 = x3;
u0_3 = u0;
DUMMY_REG_2464_3 = DUMMY_REG_2464;
r1_3 = r1;
}
...
/*§Skip§*/
<customTag4>DUMMY_REG_2465</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2465</customTag>;//event.Local

<customTag4>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2465_4 = DUMMY_REG_2465;
x4_4 = x4;
r1_4 = r1;
}

...
<customTag1>x2</customTag> = <customTag1>r1</customTag>;
...
<customTag3>DUMMY_REG_2701</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag4>DUMMY_REG_2702</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2702</customTag>;//event.Local

<customTag4>r1</customTag> = <customTag4>r3</customTag>;
...
/*§Skip§*/
<customTag5>DUMMY_REG_2703</customTag> = atomic_load_explicit(&<customTag5>x5</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag5>r1</customTag> = <customTag5>DUMMY_REG_2703</customTag>;//event.Local

<customTag5>r1</customTag> = 1;

...
int x1_1;
int x3_1;
int DUMMY_REG_2785_1;
int r1_1;
int x2_2;
int DUMMY_REG_2786_2;
int r1_2;
int x3_3;
int u0_3;
int r1_3;
...
<customTag1>DUMMY_REG_2785</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2785</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_2785_1 = DUMMY_REG_2785;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2786</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2786</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x2_2 = x2;
DUMMY_REG_2786_2 = DUMMY_REG_2786;
r1_2 = r1;
}

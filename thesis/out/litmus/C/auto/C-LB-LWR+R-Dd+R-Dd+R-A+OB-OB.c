...
int x1_1;
int x3_1;
int DUMMY_REG_3116_1;
int r1_1;
int x2_2;
int r1_2;
int DUMMY_REG_3117_2;
int x3_3;
int x4_3;
int r1_3;
int r2_4;
...
<customTag1>DUMMY_REG_3116</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3116</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_3116_1 = DUMMY_REG_3116;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3117</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3117</customTag>;//event.Local
...
x2_2 = x2;
r1_2 = r1;
DUMMY_REG_3117_2 = DUMMY_REG_3117;
}
...
assert((((((<customAssertionTag4>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem5/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == 1)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

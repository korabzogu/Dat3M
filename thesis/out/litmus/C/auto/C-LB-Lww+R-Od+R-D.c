...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_3132</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3132</customTag>;//event.Local

atomic_store_explicit(&<customTag2>u0</customTag>, 1, memory_order_seq_cst /* TODO use usual C assign */ );//event.Store

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3132_2 = DUMMY_REG_3132;
x2_2 = x2;
u0_2 = u0;
r1_2 = r1;
}
...
assert(!(((u0 == 3) && (<customAssertionTag1>r1</customAssertionTag> == mem3)) && (<customAssertionTag2>r1</customAssertionTag> == 1)));
return 0;
}

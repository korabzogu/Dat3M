...
<customTag5>r2</customTag> = READ_ONCE(<customTag5>x0</customTag>);
...
assert(!((((((<customAssertionTag5>r2</customAssertionTag> == 0) && (<customAssertionTag0>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r2</customAssertionTag> == 0)) && (<customAssertionTag2>r2</customAssertionTag> == 0)) && (<customAssertionTag3>r2</customAssertionTag> == 0)) && (<customAssertionTag4>r2</customAssertionTag> == 0)));
return 0;
}

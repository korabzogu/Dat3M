...
<customTag1>DUMMY_REG_3222</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
<customTag2>DUMMY_REG_3223</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
<customTag3>DUMMY_REG_3224</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag4>DUMMY_REG_3225</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load
...
assert(!((((((<customAssertionTag4>r2</customAssertionTag> == 0) && (<customAssertionTag5>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == mem2)) && (<customAssertionTag2>r1</customAssertionTag> == mem4)) && (<customAssertionTag3>r1</customAssertionTag> == mem6)) && (<customAssertionTag4>r1</customAssertionTag> == mem9)));
return 0;
}

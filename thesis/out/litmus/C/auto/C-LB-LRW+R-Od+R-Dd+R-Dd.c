...
int r1_1;
int r3_2;
int DUMMY_REG_3250_2;
int x2_2;
int u0_2;
int r1_2;
int DUMMY_REG_3251_3;
int x3_3;
int r1_3;
...
<customTag2>DUMMY_REG_3250</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3250</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_3250_2 = DUMMY_REG_3250;
x2_2 = x2;
u0_2 = u0;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_3251</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3251</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3251_3 = DUMMY_REG_3251;
x3_3 = x3;
r1_3 = r1;
}

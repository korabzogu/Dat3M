...
<customTag6>r2</customTag> = atomic_load_explicit(&<customTag6>x0</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
<customTag7>x1</customTag> = 1;

<customTag7>x2</customTag> = 1;

<customTag7>x3</customTag> = 1;

<customTag7>x4</customTag> = 1;

<customTag7>x5</customTag> = 1;

<customTag7>x6</customTag> = 1;

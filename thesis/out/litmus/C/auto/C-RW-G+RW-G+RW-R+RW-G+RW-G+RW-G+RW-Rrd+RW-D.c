...
<customTag7>DUMMY_REG_3326</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_3326</customTag>;//event.Local
...
x7_7 = x7;
r1_7 = r1;
DUMMY_REG_3326_7 = DUMMY_REG_3326;
}

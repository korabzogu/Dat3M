...
/*§Skip§*/
<customTag2>DUMMY_REG_2773</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2773</customTag>;//event.Local
...
r2_2 = r2;
x2_2 = x2;
DUMMY_REG_2773_2 = DUMMY_REG_2773;
r1_2 = r1;
}

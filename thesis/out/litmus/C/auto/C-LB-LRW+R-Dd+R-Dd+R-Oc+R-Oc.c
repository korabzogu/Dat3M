...
int x1_1;
int x3_1;
int DUMMY_REG_2654_1;
int r1_1;
int x2_2;
int r1_2;
int DUMMY_REG_2655_2;
int r4_3;
int x3_3;
int x4_3;
int r1_3;
...
<customTag1>DUMMY_REG_2654</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2654</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_2654_1 = DUMMY_REG_2654;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2655</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2655</customTag>;//event.Local
...
x2_2 = x2;
r1_2 = r1;
DUMMY_REG_2655_2 = DUMMY_REG_2655;
}

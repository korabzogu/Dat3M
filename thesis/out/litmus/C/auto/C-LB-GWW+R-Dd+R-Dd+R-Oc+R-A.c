...
<customTag1>DUMMY_REG_3255</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag2>DUMMY_REG_3256</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
assert(!((((((<customAssertionTag5>r1</customAssertionTag> == 1) && (<customAssertionTag5>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == mem2)) && (<customAssertionTag2>r1</customAssertionTag> == mem5)) && (<customAssertionTag3>r1</customAssertionTag> == 1)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

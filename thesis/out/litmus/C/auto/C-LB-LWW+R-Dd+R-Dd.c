...
int r3_1;
int x1_1;
int DUMMY_REG_3232_1;
int u0_1;
int r1_1;
int DUMMY_REG_3233_2;
int x2_2;
int r1_2;
...
<customTag1>DUMMY_REG_3232</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3232</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_3232_1 = DUMMY_REG_3232;
u0_1 = u0;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3233</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3233</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3233_2 = DUMMY_REG_3233;
x2_2 = x2;
r1_2 = r1;
}
...
assert((((u0 == 3) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)));
return 0;
}

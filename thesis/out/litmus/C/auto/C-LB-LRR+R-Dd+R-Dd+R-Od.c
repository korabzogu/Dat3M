...
int r3_1;
int x1_1;
int DUMMY_REG_2971_1;
int x3_1;
int r1_1;
int r3_2;
int x2_2;
int u0_2;
int DUMMY_REG_2972_2;
int r1_2;
int r2_3;
int x3_3;
int r1_3;
...
<customTag1>DUMMY_REG_2971</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2971</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_2971_1 = DUMMY_REG_2971;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2972</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2972</customTag>;//event.Local
...
x2_2 = x2;
u0_2 = u0;
DUMMY_REG_2972_2 = DUMMY_REG_2972;
r1_2 = r1;
}

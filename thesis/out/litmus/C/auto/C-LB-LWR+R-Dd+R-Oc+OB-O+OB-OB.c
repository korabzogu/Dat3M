...
/*§Skip§*/
<customTag1>DUMMY_REG_2706</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2706</customTag>;//event.Local

<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2706_1 = DUMMY_REG_2706;
x1_1 = x1;
r1_1 = r1;
}

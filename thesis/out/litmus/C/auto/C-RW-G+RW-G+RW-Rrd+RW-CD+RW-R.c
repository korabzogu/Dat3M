...
<customTag3>DUMMY_REG_2288</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2288</customTag>;//event.Local
...
x3_3 = x3;
y4_3 = y4;
DUMMY_REG_2288_3 = DUMMY_REG_2288;
r1_3 = r1;
}
...
assert((((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == &mem5/* Address */)) && (<customAssertionTag4>r1</customAssertionTag> == 1)));
return 0;
}

...
__VERIFIER_fence(Sync_rcu);
<customTag6>r2</customTag> = READ_ONCE(<customTag6>x0</customTag>);
...
WRITE_ONCE(&<customTag7>x1</customTag>, 1);
WRITE_ONCE(&<customTag7>x2</customTag>, 1);
WRITE_ONCE(&<customTag7>x3</customTag>, 1);
WRITE_ONCE(&<customTag7>x4</customTag>, 1);
WRITE_ONCE(&<customTag7>x5</customTag>, 1);
WRITE_ONCE(&<customTag7>x6</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x0_7 = x0;
x1_7 = x1;
x2_7 = x2;

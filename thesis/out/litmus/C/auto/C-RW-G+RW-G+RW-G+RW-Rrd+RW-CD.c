...
<customTag4>DUMMY_REG_2315</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2315</customTag>;//event.Local
...
y0_4 = y0;
x4_4 = x4;
DUMMY_REG_2315_4 = DUMMY_REG_2315;
r1_4 = r1;
}

...
int r1_0;
int r3_1;
int DUMMY_REG_2394_1;
int x1_1;
int v0_1;
int r1_1;
int r2_2;
int DUMMY_REG_2395_2;
int x2_2;
int r1_2;
int v0_3;
int u0_3;
...
<customTag1>DUMMY_REG_2394</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2394</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2394_1 = DUMMY_REG_2394;
x1_1 = x1;
v0_1 = v0;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2395</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2395</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r2_2 = r2;
DUMMY_REG_2395_2 = DUMMY_REG_2395;
x2_2 = x2;
r1_2 = r1;
}
...
assert(((((<customAssertionTag2>r2</customAssertionTag> == 0) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem5/* Address */)));
return 0;
}

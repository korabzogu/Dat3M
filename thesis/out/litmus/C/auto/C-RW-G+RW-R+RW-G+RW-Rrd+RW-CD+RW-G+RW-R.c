...
<customTag4>DUMMY_REG_3304</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_3304</customTag>;//event.Local
...
y5_4 = y5;
r1_4 = r1;
DUMMY_REG_3304_4 = DUMMY_REG_3304;
}

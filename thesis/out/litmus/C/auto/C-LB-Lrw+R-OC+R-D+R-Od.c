...
<customTag2>DUMMY_REG_2291</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2291</customTag>;//event.Local

<customTag2>x3</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_2291_2 = DUMMY_REG_2291;
x2_2 = x2;
x3_2 = x3;
u0_2 = u0;
r1_2 = r1;

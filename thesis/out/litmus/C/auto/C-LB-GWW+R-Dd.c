...
/*§Skip§*/
<customTag1>DUMMY_REG_3281</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3281</customTag>;//event.Local

<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3281_1 = DUMMY_REG_3281;
x1_1 = x1;
r1_1 = r1;
}
...
assert((((<customAssertionTag2>r1</customAssertionTag> == 1) && (<customAssertionTag2>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == &mem3/* Address */)));
return 0;
}

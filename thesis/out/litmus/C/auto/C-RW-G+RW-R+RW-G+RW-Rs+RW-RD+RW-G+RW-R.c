...
__VERIFIER_HARDWARE(NULL);
<customTag4>DUMMY_REG_2428</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2428</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_4 = r4;
DUMMY_REG_2428_4 = DUMMY_REG_2428;
x4_4 = x4;
y5_4 = y5;
r1_4 = r1;
}

...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_2523</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2523</customTag>;//event.Local
...
u0_3 = u0;
r1_3 = r1;
DUMMY_REG_2523_3 = DUMMY_REG_2523;
}
...
assert(!((((u0 == 3) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == mem4)) && (<customAssertionTag3>r1</customAssertionTag> == 1)));
return 0;
}

...
<customTag1>DUMMY_REG_3294</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
<customTag2>DUMMY_REG_3295</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag3>DUMMY_REG_3296</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load
...
<customTag4>DUMMY_REG_3297</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>, memory_order_relaxed);//event.Load
...
WRITE_ONCE(&<customTag4>u0</customTag>, <customTag4>r1</customTag>);
} else {}

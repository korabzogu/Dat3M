...
/*§Skip§*/
<customTag2>DUMMY_REG_2281</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
assert(((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag2>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == &mem2/* Address */)));
return 0;
}

...
/*§Skip§*/
/*§Skip§*/
<customTag5>r3</customTag> = <customTag5>x7</customTag>;//event.Local

__VERIFIER_fence(Rcu_lock);
<customTag5>r1</customTag> = READ_ONCE(<customTag5>x5</customTag>);

atomic_store_explicit(&<customTag5>x6</customTag>, <customTag5>r3</customTag>, memory_order_release );//event.Store
...
/*§Skip§*/
/*§Skip§*/
<customTag6>r4</customTag> = <customTag6>y7</customTag>;//event.Local

__VERIFIER_fence(Rcu_lock);
<customTag6>DUMMY_REG_2380</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_2380</customTag>;//event.Local

<customTag6>r4</customTag> = (<customTag6>r1</customTag>)!=(<customTag6>r4</customTag>);//event.Local

if(<customTag6>r4</customTag>) {
WRITE_ONCE(&<customTag6>r1</customTag>, 1);
} else {}
...
atomic_thread_fence(memory_order_seq_cst);
r4_6 = r4;
DUMMY_REG_2380_6 = DUMMY_REG_2380;
x6_6 = x6;
y7_6 = y7;
r1_6 = r1;
}

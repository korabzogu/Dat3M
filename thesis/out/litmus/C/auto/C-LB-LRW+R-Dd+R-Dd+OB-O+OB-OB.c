...
int x1_1;
int x3_1;
int DUMMY_REG_3426_1;
int r1_1;
int DUMMY_REG_3427_2;
int x2_2;
int r1_2;
int x3_3;
int x4_3;
...
<customTag1>DUMMY_REG_3426</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3426</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_3426_1 = DUMMY_REG_3426;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3427</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3427</customTag>;//event.Local

__VERIFIER_fence(Mb);
WRITE_ONCE(&<customTag2>r1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3427_2 = DUMMY_REG_3427;
x2_2 = x2;
r1_2 = r1;
}

...
<customTag5>x6</customTag> = <customTag5>r3</customTag>;
...
<customTag6>DUMMY_REG_3339</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

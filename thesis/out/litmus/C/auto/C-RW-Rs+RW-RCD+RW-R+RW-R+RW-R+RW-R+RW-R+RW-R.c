...
__VERIFIER_fence(Rcu_lock);
<customTag1>DUMMY_REG_2184</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

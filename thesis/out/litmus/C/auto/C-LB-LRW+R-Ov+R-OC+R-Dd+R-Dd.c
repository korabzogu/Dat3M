...
int x3_3;
int u0_3;
int DUMMY_REG_2632_3;
int r1_3;
int x4_4;
int r1_4;
int DUMMY_REG_2633_4;
...
<customTag3>DUMMY_REG_2632</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2632</customTag>;//event.Local
...
x3_3 = x3;
u0_3 = u0;
DUMMY_REG_2632_3 = DUMMY_REG_2632;
r1_3 = r1;
}
...
/*§Skip§*/
<customTag4>DUMMY_REG_2633</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2633</customTag>;//event.Local
...
x4_4 = x4;
r1_4 = r1;
DUMMY_REG_2633_4 = DUMMY_REG_2633;
}
...
assert((((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag4>r1</customAssertionTag> == &mem4/* Address */)));
return 0;
}

...
int r3_1;
int x1_1;
int DUMMY_REG_2289_1;
int x3_1;
int r1_1;
int DUMMY_REG_2290_2;
int x2_2;
int r1_2;
int v0_3;
int x3_3;
...
<customTag1>DUMMY_REG_2289</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2289</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_2289_1 = DUMMY_REG_2289;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2290</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2290</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2290_2 = DUMMY_REG_2290;
x2_2 = x2;
r1_2 = r1;
}
...
assert((((((<customAssertionTag4>r1</customAssertionTag> == 1) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem5/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == 1)));
return 0;
}

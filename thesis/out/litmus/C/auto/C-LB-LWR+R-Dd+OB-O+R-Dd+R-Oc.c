...
/*§Skip§*/
<customTag1>DUMMY_REG_2397</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2397</customTag>;//event.Local

__VERIFIER_HARDWARE(NULL);
<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2397_1 = DUMMY_REG_2397;
x1_1 = x1;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2398</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2398</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2398_3 = DUMMY_REG_2398;
r1_3 = r1;
}

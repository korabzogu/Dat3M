...
int u0_0;
int r3_1;
int DUMMY_REG_3409_1;
int x1_1;
int v0_1;
int r1_1;
int r2_2;
int x2_2;
int DUMMY_REG_3410_2;
int r1_2;
int r2_3;
int v0_3;
int u0_3;
...
<customTag1>DUMMY_REG_3409</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3409</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_3409_1 = DUMMY_REG_3409;
x1_1 = x1;
v0_1 = v0;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3410</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3410</customTag>;//event.Local
...
r2_2 = r2;
x2_2 = x2;
DUMMY_REG_3410_2 = DUMMY_REG_3410;
r1_2 = r1;
}
...
assert(((((<customAssertionTag2>r2</customAssertionTag> == 0) && (<customAssertionTag3>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem5/* Address */)));
return 0;
}

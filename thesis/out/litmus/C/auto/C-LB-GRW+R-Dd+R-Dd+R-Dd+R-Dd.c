...
int x1_1;
int x3_1;
int DUMMY_REG_3107_1;
int r1_1;
int r3_2;
int DUMMY_REG_3108_2;
int x2_2;
int x4_2;
int r1_2;
int DUMMY_REG_3109_3;
int r3_3;
int v0_3;
int x3_3;
int r1_3;
int DUMMY_REG_3110_4;
int x4_4;
int r1_4;
int v0_5;
int u0_5;
...
<customTag1>DUMMY_REG_3107</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3107</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_3107_1 = DUMMY_REG_3107;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_3108</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3108</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_3108_2 = DUMMY_REG_3108;
x2_2 = x2;
x4_2 = x4;
r1_2 = r1;
}
...
<customTag3>DUMMY_REG_3109</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3109</customTag>;//event.Local

<customTag3>r1</customTag> = <customTag3>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3109_3 = DUMMY_REG_3109;
r3_3 = r3;
v0_3 = v0;
x3_3 = x3;
r1_3 = r1;
...
/*§Skip§*/
<customTag4>DUMMY_REG_3110</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_3110</customTag>;//event.Local

<customTag4>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3110_4 = DUMMY_REG_3110;
x4_4 = x4;
r1_4 = r1;
}

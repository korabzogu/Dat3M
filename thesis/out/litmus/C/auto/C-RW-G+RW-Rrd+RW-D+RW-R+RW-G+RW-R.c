...
<customTag2>DUMMY_REG_2695</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2695</customTag>;//event.Local
...
x2_2 = x2;
y3_2 = y3;
DUMMY_REG_2695_2 = DUMMY_REG_2695;
r1_2 = r1;
}

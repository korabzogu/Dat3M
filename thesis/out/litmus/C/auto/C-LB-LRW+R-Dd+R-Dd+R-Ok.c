...
int r1_0;
int r3_1;
int DUMMY_REG_2208_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_2209_2;
int x2_2;
int r1_2;
int r4_3;
int z3_3;
...
<customTag1>DUMMY_REG_2208</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2208</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2208_1 = DUMMY_REG_2208;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2209</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2209</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2209_2 = DUMMY_REG_2209;
x2_2 = x2;
r1_2 = r1;
}
...
<customTag3>r4</customTag> = atomic_load_explicit(&<customTag3>z3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use macro WRITE_ONCE*/);//event.Load
...
int z3 = atomic_load_explicit(&mem6, memory_order_relaxed);

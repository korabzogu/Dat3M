...
<customTag1>r2</customTag> = READ_ONCE(<customTag1>x0</customTag>);
...
WRITE_ONCE(&<customTag2>x1</customTag>, 1);
atomic_thread_fence(memory_order_seq_cst);
x0_2 = x0;
x1_2 = x1;
}
...
assert(!((((<customAssertionTag1>r2</customAssertionTag> == 0) && (<customAssertionTag0>r1</customAssertionTag> == 1)) && (<customAssertionTag0>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == 1)));
return 0;
}

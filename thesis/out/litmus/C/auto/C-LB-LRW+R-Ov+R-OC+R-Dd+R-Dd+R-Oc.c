...
int x3_3;
int x5_3;
int DUMMY_REG_2268_3;
int r1_3;
int x4_4;
int DUMMY_REG_2269_4;
int r1_4;
int r4_5;
int u0_5;
int x5_5;
...
<customTag3>DUMMY_REG_2268</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2268</customTag>;//event.Local
...
x3_3 = x3;
x5_3 = x5;
DUMMY_REG_2268_3 = DUMMY_REG_2268;
r1_3 = r1;
}
...
/*§Skip§*/
<customTag4>DUMMY_REG_2269</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_2269</customTag>;//event.Local

<customTag4>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x4_4 = x4;
DUMMY_REG_2269_4 = DUMMY_REG_2269;
r1_4 = r1;
}
...
/*§Skip§*/
/*§Skip§*/
<customTag5>r4</customTag> = 1;//event.Local
...
<customTag5>r4</customTag> = (<customTag5>r1</customTag>)==(<customTag5>r4</customTag>);//event.Local

if(<customTag5>r4</customTag>) {
...
int x1 = atomic_load_explicit(&mem5, memory_order_relaxed);
int y3 = atomic_load_explicit(&mem1, memory_order_relaxed);
int x2 = atomic_load_explicit(&mem6, memory_order_relaxed);
...
assert(((((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag4>r1</customAssertionTag> == &mem7/* Address */)) && (<customAssertionTag5>r1</customAssertionTag> == 1)));
return 0;
}

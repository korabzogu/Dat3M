...
/*§Skip§*/
/*§Skip§*/
<customTag6>r3</customTag> = <customTag6>x0</customTag>;//event.Local

__VERIFIER_fence(Rcu_lock);
<customTag6>r1</customTag> = READ_ONCE(<customTag6>x6</customTag>);

atomic_store_explicit(&<customTag6>x7</customTag>, <customTag6>r3</customTag>, memory_order_release );//event.Store
...
/*§Skip§*/
/*§Skip§*/
<customTag7>r4</customTag> = <customTag7>y0</customTag>;//event.Local

<customTag7>DUMMY_REG_2306</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>, memory_order_relaxed);//event.Load

<customTag7>r1</customTag> = <customTag7>DUMMY_REG_2306</customTag>;//event.Local

<customTag7>r4</customTag> = (<customTag7>r1</customTag>)!=(<customTag7>r4</customTag>);//event.Local

if(<customTag7>r4</customTag>) {
WRITE_ONCE(&<customTag7>r1</customTag>, 1);
} else {}
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2306_7 = DUMMY_REG_2306;
r4_7 = r4;
y0_7 = y0;
x7_7 = x7;
r1_7 = r1;
...
int x7 = atomic_load_explicit(&mem0, memory_order_relaxed);

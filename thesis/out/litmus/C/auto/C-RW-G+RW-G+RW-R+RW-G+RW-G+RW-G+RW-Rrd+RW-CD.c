...
<customTag6>x7</customTag> = <customTag6>r3</customTag>;
...
<customTag7>DUMMY_REG_3387</customTag> = atomic_load_explicit(&<customTag7>x7</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

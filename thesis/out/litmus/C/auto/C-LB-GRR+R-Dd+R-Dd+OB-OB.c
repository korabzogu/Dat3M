...
int x1_1;
int x3_1;
int DUMMY_REG_2698_1;
int r1_1;
int x2_2;
int r1_2;
int DUMMY_REG_2699_2;
int r2_3;
int v0_3;
int x3_3;
int r1_3;
...
<customTag1>DUMMY_REG_2698</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2698</customTag>;//event.Local
...
x1_1 = x1;
x3_1 = x3;
DUMMY_REG_2698_1 = DUMMY_REG_2698;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2699</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2699</customTag>;//event.Local
...
x2_2 = x2;
r1_2 = r1;
DUMMY_REG_2699_2 = DUMMY_REG_2699;
}

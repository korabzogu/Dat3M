...
/*§Skip§*/
/*§Skip§*/
<customTag1>DUMMY_REG_2981</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2981</customTag>;//event.Local
...
x1_1 = x1;
u0_1 = u0;
DUMMY_REG_2981_1 = DUMMY_REG_2981;
r1_1 = r1;
}

...
int r3_1;
int x1_1;
int DUMMY_REG_2564_1;
int x3_1;
int r1_1;
int r3_2;
int x2_2;
int v0_2;
int DUMMY_REG_2565_2;
int r1_2;
int x3_3;
int DUMMY_REG_2566_3;
int r1_3;
int r2_4;
int v0_4;
int u0_4;
...
<customTag1>DUMMY_REG_2564</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2564</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_2564_1 = DUMMY_REG_2564;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2565</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2565</customTag>;//event.Local
...
x2_2 = x2;
v0_2 = v0;
DUMMY_REG_2565_2 = DUMMY_REG_2565;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2566</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2566</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2566_3 = DUMMY_REG_2566;
r1_3 = r1;
}
...
assert((((((<customAssertionTag4>r1</customAssertionTag> == 1) && (<customAssertionTag4>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == &mem7/* Address */)));
return 0;
}

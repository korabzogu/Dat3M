...
<customTag2>DUMMY_REG_3157</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3157</customTag>;//event.Local
...
x3_2 = x3;
u0_2 = u0;
DUMMY_REG_3157_2 = DUMMY_REG_3157;
r1_2 = r1;
}

...
/*§Skip§*/
<customTag2>DUMMY_REG_2692</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2692</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r2_2 = r2;
DUMMY_REG_2692_2 = DUMMY_REG_2692;
x2_2 = x2;
r1_2 = r1;
}
...
assert(((((<customAssertionTag2>r2</customAssertionTag> == 0) && (<customAssertionTag3>r2</customAssertionTag> == 0)) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)));
return 0;
}

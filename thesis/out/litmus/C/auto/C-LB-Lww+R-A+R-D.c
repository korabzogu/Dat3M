...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2686</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2686</customTag>;//event.Local
...
x2_2 = x2;
u0_2 = u0;
DUMMY_REG_2686_2 = DUMMY_REG_2686;
r1_2 = r1;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_3436</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3436</customTag>;//event.Local
...
x1_1 = x1;
r1_1 = r1;
DUMMY_REG_3436_1 = DUMMY_REG_3436;
}

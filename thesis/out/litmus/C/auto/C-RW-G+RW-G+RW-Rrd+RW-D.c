...
<customTag3>DUMMY_REG_2993</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2993</customTag>;//event.Local
...
r4_3 = r4;
y0_3 = y0;
DUMMY_REG_2993_3 = DUMMY_REG_2993;
x3_3 = x3;
r1_3 = r1;
}

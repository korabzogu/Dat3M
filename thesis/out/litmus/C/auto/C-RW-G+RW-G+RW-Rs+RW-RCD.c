...
__VERIFIER_HARDWARE(NULL);
<customTag3>DUMMY_REG_2697</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2697</customTag>;//event.Local
...
y0_3 = y0;
x3_3 = x3;
DUMMY_REG_2697_3 = DUMMY_REG_2697;
r1_3 = r1;
}

...
int x2_0;
int u0_0;
int DUMMY_REG_2405_1;
int r3_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_2406_2;
int x2_2;
int r1_2;
int x3_3;
int x4_3;
...
<customTag1>DUMMY_REG_2405</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2405</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2405_1 = DUMMY_REG_2405;
r3_1 = r3;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
...
/*§Skip§*/
<customTag2>DUMMY_REG_2406</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2406</customTag>;//event.Local

<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2406_2 = DUMMY_REG_2406;
x2_2 = x2;
r1_2 = r1;
}

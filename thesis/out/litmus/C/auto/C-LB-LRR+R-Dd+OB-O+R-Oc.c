...
/*§Skip§*/
<customTag1>DUMMY_REG_3343</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3343</customTag>;//event.Local

__VERIFIER_HARDWARE(NULL);
<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3343_1 = DUMMY_REG_3343;
x1_1 = x1;
r1_1 = r1;
}

...
__VERIFIER_fence(Rcu_lock);
<customTag6>DUMMY_REG_3002</customTag> = atomic_load_explicit(&<customTag6>x6</customTag>, memory_order_relaxed);//event.Load

<customTag6>r1</customTag> = <customTag6>DUMMY_REG_3002</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_6 = r4;
DUMMY_REG_3002_6 = DUMMY_REG_3002;
x6_6 = x6;
y7_6 = y7;
r1_6 = r1;
}

...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2445</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2445</customTag>;//event.Local
...
x2_2 = x2;
x3_2 = x3;
DUMMY_REG_2445_2 = DUMMY_REG_2445;
r1_2 = r1;
}

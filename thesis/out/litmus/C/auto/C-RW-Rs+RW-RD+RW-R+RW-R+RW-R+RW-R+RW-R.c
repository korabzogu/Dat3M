...
__VERIFIER_HARDWARE(NULL);
<customTag1>DUMMY_REG_2634</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2634</customTag>;//event.Local
...
x1_1 = x1;
y2_1 = y2;
DUMMY_REG_2634_1 = DUMMY_REG_2634;
r1_1 = r1;
}

...
/*§Skip§*/
/*§Skip§*/
<customTag2>DUMMY_REG_2732</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2732</customTag>;//event.Local
...
u0_2 = u0;
r1_2 = r1;
DUMMY_REG_2732_2 = DUMMY_REG_2732;
}

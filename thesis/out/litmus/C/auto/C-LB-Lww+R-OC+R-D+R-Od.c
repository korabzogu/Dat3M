...
<customTag2>DUMMY_REG_2454</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2454</customTag>;//event.Local
...
r3_2 = r3;
x2_2 = x2;
DUMMY_REG_2454_2 = DUMMY_REG_2454;
x3_2 = x3;
u0_2 = u0;
r1_2 = r1;
}
...
atomic_store_explicit(&<customTag3>r1</customTag>, 1, memory_order_seq_cst /* TODO use usual C assign */ );//event.Store
...
assert(!((((u0 == 3) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == mem2)));
return 0;
}

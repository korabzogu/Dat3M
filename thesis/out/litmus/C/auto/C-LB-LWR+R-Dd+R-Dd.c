...
int u0_0;
int r3_1;
int DUMMY_REG_3077_1;
int x1_1;
int u0_1;
int r1_1;
int r2_2;
int DUMMY_REG_3078_2;
int x2_2;
int r1_2;
...
<customTag1>DUMMY_REG_3077</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3077</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_3077_1 = DUMMY_REG_3077;
x1_1 = x1;
u0_1 = u0;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_3078</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3078</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r2_2 = r2;
DUMMY_REG_3078_2 = DUMMY_REG_3078;
x2_2 = x2;
r1_2 = r1;
}
...
assert((((<customAssertionTag2>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)));
return 0;
}

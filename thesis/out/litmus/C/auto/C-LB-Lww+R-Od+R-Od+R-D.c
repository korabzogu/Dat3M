...
/*§Skip§*/
/*§Skip§*/
<customTag3>DUMMY_REG_2422</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2422</customTag>;//event.Local
...
x3_3 = x3;
u0_3 = u0;
DUMMY_REG_2422_3 = DUMMY_REG_2422;
r1_3 = r1;
}

...
/*§Skip§*/
<customTag1>DUMMY_REG_2336</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2336</customTag>;//event.Local
...
x1_1 = x1;
r1_1 = r1;
DUMMY_REG_2336_1 = DUMMY_REG_2336;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_2337</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2337</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_2337_3 = DUMMY_REG_2337;
r1_3 = r1;
}

...
int r3_1;
int x1_1;
int DUMMY_REG_2484_1;
int x3_1;
int r1_1;
int r3_2;
int DUMMY_REG_2485_2;
int x2_2;
int u0_2;
int r1_2;
int r4_3;
...
<customTag1>DUMMY_REG_2484</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2484</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_2484_1 = DUMMY_REG_2484;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_2485</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2485</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_2485_2 = DUMMY_REG_2485;
x2_2 = x2;
u0_2 = u0;
r1_2 = r1;
}
...
/*§Skip§*/
/*§Skip§*/
<customTag3>r4</customTag> = <customTag3>u0</customTag>;//event.Local

<customTag3>DUMMY_REG_2486</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2486</customTag>;//event.Local
...
x3_3 = x3;
u0_3 = u0;
DUMMY_REG_2486_3 = DUMMY_REG_2486;
r1_3 = r1;
}
...
assert(((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)) && (<customAssertionTag2>r1</customAssertionTag> == &mem4/* Address */)) && (<customAssertionTag3>r1</customAssertionTag> == &mem6/* Address */)));
return 0;
}

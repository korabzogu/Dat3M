...
/*§Skip§*/
<customTag1>DUMMY_REG_2368</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2368</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_2368_1 = DUMMY_REG_2368;
r1_1 = r1;
}

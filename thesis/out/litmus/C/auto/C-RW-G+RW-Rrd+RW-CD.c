...
/*§Skip§*/
/*§Skip§*/
<customTag1>r3</customTag> = <customTag1>x0</customTag>;//event.Local
...
/*§Skip§*/
/*§Skip§*/
<customTag2>r4</customTag> = <customTag2>y0</customTag>;//event.Local

<customTag2>DUMMY_REG_2506</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2506</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_2 = r4;
DUMMY_REG_2506_2 = DUMMY_REG_2506;
y0_2 = y0;
x2_2 = x2;
r1_2 = r1;
}
...
assert((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == &mem2/* Address */)));
return 0;
}

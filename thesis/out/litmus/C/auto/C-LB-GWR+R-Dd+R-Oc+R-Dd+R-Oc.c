...
/*§Skip§*/
<customTag1>DUMMY_REG_3279</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3279</customTag>;//event.Local

<customTag1>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
x1_1 = x1;
DUMMY_REG_3279_1 = DUMMY_REG_3279;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_3280</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3280</customTag>;//event.Local

<customTag3>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_3280_3 = DUMMY_REG_3280;
x3_3 = x3;
r1_3 = r1;
}

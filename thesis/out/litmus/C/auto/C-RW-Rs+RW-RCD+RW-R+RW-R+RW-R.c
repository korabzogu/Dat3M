...
__VERIFIER_HARDWARE(NULL);
<customTag1>DUMMY_REG_3065</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3065</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_1 = r4;
DUMMY_REG_3065_1 = DUMMY_REG_3065;
x1_1 = x1;
y2_1 = y2;
r1_1 = r1;
}

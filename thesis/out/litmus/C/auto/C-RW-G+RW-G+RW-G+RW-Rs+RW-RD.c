...
/*§Skip§*/
/*§Skip§*/
<customTag3>r3</customTag> = <customTag3>x0</customTag>;//event.Local
...
<customTag3>x4</customTag> = <customTag3>r3</customTag>;
...
/*§Skip§*/
/*§Skip§*/
<customTag4>r4</customTag> = <customTag4>y0</customTag>;//event.Local

__VERIFIER_HARDWARE(NULL);
<customTag4>DUMMY_REG_3154</customTag> = atomic_load_explicit(&<customTag4>x4</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag4>r1</customTag> = <customTag4>DUMMY_REG_3154</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
r4_4 = r4;
DUMMY_REG_3154_4 = DUMMY_REG_3154;
y0_4 = y0;
x4_4 = x4;
r1_4 = r1;
}
...
assert((((((<customAssertionTag0>r1</customAssertionTag> == 1) && (<customAssertionTag1>r1</customAssertionTag> == 1)) && (<customAssertionTag2>r1</customAssertionTag> == 1)) && (<customAssertionTag3>r1</customAssertionTag> == 1)) && (<customAssertionTag4>r1</customAssertionTag> == &mem2/* Address */)));
return 0;
}

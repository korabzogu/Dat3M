...
<customTag2>r2</customTag> = atomic_load_explicit(&<customTag2>r1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use usual C assign */);//event.Load

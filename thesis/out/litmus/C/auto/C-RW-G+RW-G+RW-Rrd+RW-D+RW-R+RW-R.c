...
<customTag3>DUMMY_REG_2213</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_2213</customTag>;//event.Local
...
x3_3 = x3;
y4_3 = y4;
DUMMY_REG_2213_3 = DUMMY_REG_2213;
r1_3 = r1;
}

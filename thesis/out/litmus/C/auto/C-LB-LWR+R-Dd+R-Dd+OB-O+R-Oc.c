...
int u0_0;
int r3_1;
int DUMMY_REG_2926_1;
int x1_1;
int x3_1;
int r1_1;
int DUMMY_REG_2927_2;
int x2_2;
int r1_2;
int x3_3;
int x4_3;
...
<customTag1>DUMMY_REG_2926</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_2926</customTag>;//event.Local

<customTag1>r1</customTag> = <customTag1>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_1 = r3;
DUMMY_REG_2926_1 = DUMMY_REG_2926;
x1_1 = x1;
x3_1 = x3;
r1_1 = r1;
}
...
/*§Skip§*/
<customTag2>DUMMY_REG_2927</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_2927</customTag>;//event.Local

__VERIFIER_HARDWARE(NULL);
<customTag2>r1</customTag> = 1;

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2927_2 = DUMMY_REG_2927;
x2_2 = x2;
r1_2 = r1;
}

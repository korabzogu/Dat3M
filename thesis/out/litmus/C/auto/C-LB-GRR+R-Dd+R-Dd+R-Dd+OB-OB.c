...
int r3_1;
int x1_1;
int DUMMY_REG_3210_1;
int x3_1;
int r1_1;
int r3_2;
int DUMMY_REG_3211_2;
int x2_2;
int x4_2;
int r1_2;
int x3_3;
int DUMMY_REG_3212_3;
int r1_3;
int r2_4;
int v0_4;
int x4_4;
...
<customTag1>DUMMY_REG_3210</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag1>r1</customTag> = <customTag1>DUMMY_REG_3210</customTag>;//event.Local
...
r3_1 = r3;
x1_1 = x1;
DUMMY_REG_3210_1 = DUMMY_REG_3210;
x3_1 = x3;
r1_1 = r1;
}
...
<customTag2>DUMMY_REG_3211</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag2>r1</customTag> = <customTag2>DUMMY_REG_3211</customTag>;//event.Local

<customTag2>r1</customTag> = <customTag2>r3</customTag>;

atomic_thread_fence(memory_order_seq_cst);
r3_2 = r3;
DUMMY_REG_3211_2 = DUMMY_REG_3211;
x2_2 = x2;
x4_2 = x4;
r1_2 = r1;
}
...
/*§Skip§*/
<customTag3>DUMMY_REG_3212</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag3>r1</customTag> = <customTag3>DUMMY_REG_3212</customTag>;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
x3_3 = x3;
DUMMY_REG_3212_3 = DUMMY_REG_3212;
r1_3 = r1;
}

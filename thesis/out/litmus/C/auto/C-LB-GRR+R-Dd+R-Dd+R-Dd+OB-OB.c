...
<customTag1>DUMMY_REG_3210</customTag> = atomic_load_explicit(&<customTag1>x1</customTag>, memory_order_relaxed);//event.Load
...
<customTag2>DUMMY_REG_3211</customTag> = atomic_load_explicit(&<customTag2>x2</customTag>, memory_order_relaxed);//event.Load
...
/*§Skip§*/
<customTag3>DUMMY_REG_3212</customTag> = atomic_load_explicit(&<customTag3>x3</customTag>, memory_order_relaxed);//event.Load

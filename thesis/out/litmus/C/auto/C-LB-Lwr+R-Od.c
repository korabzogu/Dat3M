...
/*§Skip§*/
/*§Skip§*/
<customTag0>r3</customTag> = <customTag0>u0</customTag>;//event.Local
...
<customTag1>r2</customTag> = atomic_load_explicit(&<customTag1>r1</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_seq_cst /* TODO use usual C assign */);//event.Load
...
assert(((<customAssertionTag1>r2</customAssertionTag> == 0) && (<customAssertionTag1>r1</customAssertionTag> == &mem2/* Address */)));
return 0;
}

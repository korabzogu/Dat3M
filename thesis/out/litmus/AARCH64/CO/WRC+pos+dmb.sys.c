...
assert(!!((((X0_1 == 0) && ((((X0_2 == 0) && (((x == 1) && (((X2_2 == 2) || (X2_2 == 1)) || (X2_2 == 0))) || ((x == 2) && (((X2_2 == 0) || (X2_2 == 1)) || (X2_2 == 2))))) || ((X0_2 == 1) && (((X2_2 == 1) && ((x == 1) || (x == 2))) || ((X2_2 == 2) && (x == 2))))) || ((X0_2 == 2) && (((X2_2 == 2) && ((x == 2) || (x == 1))) || ((X2_2 == 1) && (x == 1)))))) || (((X0_1 == 1) && (x == 2)) && ((((X0_2 == 0) && (((X2_2 == 0) || (X2_2 == 1)) || (X2_2 == 2))) || ((X0_2 == 1) && ((X2_2 == 2) || (X2_2 == 1)))) || ((X0_2 == 2) && (X2_2 == 2)))))));
return 0;
}

...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_40</customTag>, memory_order_relaxed);//event.Load
...
<customTag2>X2</customTag> = atomic_load_explicit(&<customTag2>X3</customTag>, memory_order_relaxed);//event.Load

...
<customTag0>X3</customTag> = <customTag0>X4</customTag>;

<customTag0>X5</customTag> = atomic_load_explicit(&<customTag0>X3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
assert(((((((x == 1) && (y == 2)) && (<customAssertionTag0>X5</customAssertionTag> == 2)) && (<customAssertionTag0>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 2)) && (<customAssertionTag1>X4</customAssertionTag> == 0)));
return 0;
}

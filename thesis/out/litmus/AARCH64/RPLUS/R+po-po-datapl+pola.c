...
atomic_store_explicit(&mem3, X6, memory_order_release );//event.Store
...
atomic_store_explicit(&mem3, X0, memory_order_release );//event.Store
...
assert((((((a == 2) && (x == 1)) && (y == 1)) && (X8_0 == 2)) && (X2_1 == 0)));
return 0;
}

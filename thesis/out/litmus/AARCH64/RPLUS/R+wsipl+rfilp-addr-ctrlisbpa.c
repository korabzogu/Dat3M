...
<customTag1>DUMMY_REG_2166</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2166</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>X1</customTag>, memory_order_acquire);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
DUMMY_REG_2166_1 = DUMMY_REG_2166;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;

...
<customTag1>DUMMY_REG_2156</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2156</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2156_1 = DUMMY_REG_2156;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}
...
assert(!((((x == 1) && (y == 2)) && (<customAssertionTag0>X4</customAssertionTag> == 2)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

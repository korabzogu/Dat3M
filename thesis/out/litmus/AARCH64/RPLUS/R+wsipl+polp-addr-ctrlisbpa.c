...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2181</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>X1</customTag>, memory_order_acquire);//event.Load

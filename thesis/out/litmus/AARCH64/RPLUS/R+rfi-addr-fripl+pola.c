...
<customTag0>X4</customTag> = atomic_load_explicit(&<customTag0>DUMMY_REG_2172</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

<customTag0>X6</customTag> = 1;//event.Local

<customTag0>X5</customTag> = <customTag0>X6</customTag>;

<customTag0>X7</customTag> = atomic_load_explicit(&<customTag0>X5</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
X1 = atomic_load_explicit(&mem1/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load
...
X1 = atomic_load_explicit(&mem2/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load
...
assert((((((ok == 1) && (X1_0 == 0)) && (X4_0 == 0)) && (X1_1 == 0)) && (X4_1 == 0)));
return 0;
}

...
X1 = atomic_load_explicit(&mem1, memory_order_acquire);//event.Load
...
X1 = atomic_load_explicit(&mem2, memory_order_acquire);//event.Load

atomic_store_explicit(&mem2, X2, memory_order_release );//event.Store

...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_70</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag2>X2</customTag> = atomic_load_explicit(&<customTag2>X3</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_acquire);//event.Load

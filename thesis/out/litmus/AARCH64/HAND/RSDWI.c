...
<customTag1>X4</customTag> = <customTag1>X9</customTag>;
...
<customTag1>DUMMY_REG_98</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_98</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_99</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_99</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_99_1 = DUMMY_REG_99;
DUMMY_REG_98_1 = DUMMY_REG_98;
X6_1 = X6;
X7_1 = X7;
}
...
assert((((((z == 2) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 2)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

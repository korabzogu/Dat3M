...
int X8_1;
int X9_1;
int DUMMY_REG_1727_1;
int DUMMY_REG_1728_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
DUMMY_REG_1727 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1727, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1728 = (mem3 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1728, X7, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1727_1 = DUMMY_REG_1727;
DUMMY_REG_1728_1 = DUMMY_REG_1728;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;

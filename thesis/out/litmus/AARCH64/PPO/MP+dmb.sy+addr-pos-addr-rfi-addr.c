...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_233</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_234</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_235</customTag>, memory_order_relaxed);//event.Load

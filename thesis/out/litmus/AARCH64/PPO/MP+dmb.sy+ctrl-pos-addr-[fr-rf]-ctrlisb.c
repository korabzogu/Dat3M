...
<customTag1>DUMMY_REG_2110</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2110</customTag>, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_2110_1 = DUMMY_REG_2110;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;

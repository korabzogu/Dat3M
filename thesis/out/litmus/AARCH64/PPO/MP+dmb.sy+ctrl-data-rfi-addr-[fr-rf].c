...
<customTag1>DUMMY_REG_2064</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2064</customTag>, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X10_1 = X10;
DUMMY_REG_2064_1 = DUMMY_REG_2064;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X6_1 = X6;
...
assert(!(((((((a == 1) && (x == 2)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 1)) && (<customAssertionTag1>X8</customAssertionTag> == 0)) && (<customAssertionTag1>X10</customAssertionTag> == 1)));
return 0;
}

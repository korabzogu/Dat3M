...
DUMMY_REG_1684 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1684, X5, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1684_1 = DUMMY_REG_1684;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}
...
assert(((((((a == 1) && (x == 1)) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 1)) && (X8_1 == 0)));
return 0;
}

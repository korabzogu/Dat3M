...
DUMMY_REG_1045 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1045, X3, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1045_1 = DUMMY_REG_1045;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
}

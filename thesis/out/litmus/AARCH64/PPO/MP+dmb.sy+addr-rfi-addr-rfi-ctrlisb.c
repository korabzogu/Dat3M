...
int X8_1;
int X9_1;
int DUMMY_REG_1723_1;
int DUMMY_REG_1724_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
DUMMY_REG_1723 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1723, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1724 = (mem3 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1724, X7, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1723_1 = DUMMY_REG_1723;
DUMMY_REG_1724_1 = DUMMY_REG_1724;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X9_1 == 1)) && (X10_1 == 0)));
return 0;
}

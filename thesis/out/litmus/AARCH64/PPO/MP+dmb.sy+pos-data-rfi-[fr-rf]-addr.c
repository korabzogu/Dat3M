...
<customTag1>DUMMY_REG_582</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_582</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
assert(((((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 2)) && (<customAssertionTag1>X8</customAssertionTag> == 0)));
return 0;
}

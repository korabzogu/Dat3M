...
DUMMY_REG_1015 = (mem0 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1015, X6, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1015_1 = DUMMY_REG_1015;
X6_1 = X6;
}

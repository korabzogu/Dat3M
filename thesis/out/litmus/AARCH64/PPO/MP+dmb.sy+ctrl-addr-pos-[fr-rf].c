...
<customTag1>DUMMY_REG_1524</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1524</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1524_1 = DUMMY_REG_1524;
X8_1 = X8;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
...
assert(((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

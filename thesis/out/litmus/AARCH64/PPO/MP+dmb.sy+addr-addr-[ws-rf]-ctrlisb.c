...
int X8_1;
int X9_1;
int DUMMY_REG_1502_1;
int DUMMY_REG_1503_1;
int X10_1;
int X0_1;
int X1_1;
int X2_1;
...
<customTag1>DUMMY_REG_1502</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1502</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1503</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1503</customTag>, <customTag1>X6</customTag>, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1502_1 = DUMMY_REG_1502;
DUMMY_REG_1503_1 = DUMMY_REG_1503;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

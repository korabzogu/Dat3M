...
<customTag1>DUMMY_REG_174</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_174</customTag>, memory_order_relaxed);//event.Load

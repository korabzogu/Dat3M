...
DUMMY_REG_1580 = (mem3/* Address */ + X5) /* IEXPRBIN */;//event.Local
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1580_1 = DUMMY_REG_1580;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert((((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 0)) && (X4_1 == 1)) && (X8_1 == 1)) && (X9_1 == 0)));
return 0;
}

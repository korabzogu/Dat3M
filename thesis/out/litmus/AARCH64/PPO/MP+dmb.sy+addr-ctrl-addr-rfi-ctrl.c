...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_813</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_814</customTag> = <customTag1>X8</customTag>;

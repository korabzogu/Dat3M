...
DUMMY_REG_763 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_763, X4, memory_order_relaxed );//event.Store
...
assert((((((((x == 1) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 1)) && (X9_1 == 0)));
return 0;
}

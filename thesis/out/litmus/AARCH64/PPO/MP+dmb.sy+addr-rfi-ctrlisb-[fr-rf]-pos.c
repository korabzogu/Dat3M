...
DUMMY_REG_1671 = (mem2/* Address */ + X2) /* IEXPRBIN */;//event.Local
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1671_1 = DUMMY_REG_1671;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
...
assert(((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 0)) && (X8_1 == 1)) && (X9_1 == 1)));
return 0;
}

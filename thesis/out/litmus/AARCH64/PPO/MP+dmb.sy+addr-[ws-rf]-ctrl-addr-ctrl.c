...
atomic_store_explicit(&<customTag1>DUMMY_REG_473</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_474</customTag>, memory_order_relaxed);//event.Load

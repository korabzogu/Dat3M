...
<customTag1>DUMMY_REG_381</customTag> = <customTag1>X3</customTag>;
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_382</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

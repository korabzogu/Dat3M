...
DUMMY_REG_1485 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1485, X3, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1485_1 = DUMMY_REG_1485;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
}
...
assert(!(((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X5_1 == 2)) && (X8_1 == 1)) && (X9_1 == 1)));
return 0;
}

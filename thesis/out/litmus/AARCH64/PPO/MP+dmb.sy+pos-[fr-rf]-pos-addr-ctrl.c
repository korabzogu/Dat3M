...
<customTag1>DUMMY_REG_1316</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1316</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1316_1 = DUMMY_REG_1316;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
...
assert(!(((((((x == 1) && (y == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 2)) && (<customAssertionTag1>X4</customAssertionTag> == 2)) && (<customAssertionTag1>X8</customAssertionTag> == 0)));
return 0;
}

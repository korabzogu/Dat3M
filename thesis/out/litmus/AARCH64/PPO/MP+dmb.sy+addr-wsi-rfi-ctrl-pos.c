...
DUMMY_REG_1494 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1494, X3, memory_order_relaxed );//event.Store
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1494_1 = DUMMY_REG_1494;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X6_1 == 2)) && (X7_1 == 0)) && (X9_1 == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_322</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_323</customTag> = <customTag1>X7</customTag>;
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_324</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

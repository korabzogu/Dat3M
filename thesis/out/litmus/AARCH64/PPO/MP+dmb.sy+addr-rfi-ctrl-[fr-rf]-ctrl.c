...
DUMMY_REG_1095 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1095, X3, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1095_1 = DUMMY_REG_1095;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

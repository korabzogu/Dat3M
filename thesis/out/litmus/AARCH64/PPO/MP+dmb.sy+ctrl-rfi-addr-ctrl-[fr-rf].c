...
<customTag1>DUMMY_REG_1576</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1576</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1576_1 = DUMMY_REG_1576;
X6_1 = X6;
}

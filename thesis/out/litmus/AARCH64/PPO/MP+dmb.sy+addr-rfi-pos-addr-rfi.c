...
DUMMY_REG_213 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_213, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_214 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_214, X8, memory_order_relaxed );//event.Store

X10 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_213_1 = DUMMY_REG_213;
DUMMY_REG_214_1 = DUMMY_REG_214;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 1)) && (X10_1 == 1)));
return 0;
}

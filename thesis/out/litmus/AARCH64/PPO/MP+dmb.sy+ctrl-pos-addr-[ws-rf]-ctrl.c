...
DUMMY_REG_1062 = (mem3 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1062, X6, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1062_1 = DUMMY_REG_1062;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;

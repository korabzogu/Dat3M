...
<customTag1>DUMMY_REG_1158</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1158</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1158_1 = DUMMY_REG_1158;
X7_1 = X7;
}

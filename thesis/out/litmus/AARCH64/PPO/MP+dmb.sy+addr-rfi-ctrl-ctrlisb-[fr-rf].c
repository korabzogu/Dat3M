...
DUMMY_REG_823 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_823, X3, memory_order_relaxed );//event.Store
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X8_1 == 0)) && (X10_1 == 1)));
return 0;
}

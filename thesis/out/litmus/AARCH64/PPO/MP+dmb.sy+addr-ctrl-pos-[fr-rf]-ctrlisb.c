...
<customTag1>DUMMY_REG_1682</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1682</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1682_1 = DUMMY_REG_1682;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X7_1 = X7;

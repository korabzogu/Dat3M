...
int X0_1;
int X1_1;
int DUMMY_REG_1253_1;
int X11_1;
int X2_1;
int DUMMY_REG_1254_1;
int X3_1;
int X4_1;
int X5_1;
int X6_1;
...
<customTag1>DUMMY_REG_1253</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1253</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1254</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1254</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1253_1 = DUMMY_REG_1253;
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_1254_1 = DUMMY_REG_1254;
X3_1 = X3;
X5_1 = X5;
X7_1 = X7;
}

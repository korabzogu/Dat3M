...
DUMMY_REG_1306 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1306, X4, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1306_1 = DUMMY_REG_1306;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;

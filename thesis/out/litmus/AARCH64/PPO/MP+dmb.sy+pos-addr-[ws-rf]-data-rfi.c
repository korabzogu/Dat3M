...
DUMMY_REG_1681 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1681, X4, memory_order_relaxed );//event.Store
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1681_1 = DUMMY_REG_1681;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;

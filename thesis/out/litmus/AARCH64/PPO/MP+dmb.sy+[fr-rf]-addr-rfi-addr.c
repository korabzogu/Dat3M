...
<customTag1>DUMMY_REG_297</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_297</customTag>, <customTag1>X4</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_298</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_298</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
X0_1 = X0;
DUMMY_REG_297_1 = DUMMY_REG_297;
DUMMY_REG_298_1 = DUMMY_REG_298;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;
...
assert(!(((((((x == 1) && (y == 2)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 2)) && (<customAssertionTag1>X6</customAssertionTag> == 1)) && (<customAssertionTag1>X8</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_653</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_654</customTag> = <customTag1>X7</customTag>;

...
<customTag1>DUMMY_REG_1965</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1965</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1965_1 = DUMMY_REG_1965;
X8_1 = X8;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(!((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

...
<customTag1>DUMMY_REG_521</customTag> = <customTag1>X3</customTag>;
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_522</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
<customTag1>DUMMY_REG_192</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_192</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_193</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_193</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_192_1 = DUMMY_REG_192;
X7_1 = X7;
DUMMY_REG_193_1 = DUMMY_REG_193;
}

...
DUMMY_REG_2016 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2016, X7, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_2016_1 = DUMMY_REG_2016;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

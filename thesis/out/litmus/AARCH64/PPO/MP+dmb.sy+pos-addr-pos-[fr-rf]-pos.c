...
<customTag1>DUMMY_REG_1597</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1597</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1597_1 = DUMMY_REG_1597;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!((((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 1)) && (<customAssertionTag1>X8</customAssertionTag> == 1)));
return 0;
}

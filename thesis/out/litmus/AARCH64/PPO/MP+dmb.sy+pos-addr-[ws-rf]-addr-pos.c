...
<customTag1>DUMMY_REG_203</customTag> = <customTag1>X4</customTag>;
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_204</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
int X0_1;
int X1_1;
int DUMMY_REG_1341_1;
int X2_1;
int DUMMY_REG_1342_1;
int X3_1;
int X4_1;
int X5_1;
int X6_1;
...
<customTag1>DUMMY_REG_1341</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1341</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1342</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_1342</customTag> = <customTag1>X7</customTag>;
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1341_1 = DUMMY_REG_1341;
X2_1 = X2;
DUMMY_REG_1342_1 = DUMMY_REG_1342;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
...
assert(((((((((x == 2) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 1)));
return 0;
}

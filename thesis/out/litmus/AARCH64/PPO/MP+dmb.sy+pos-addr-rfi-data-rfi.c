...
DUMMY_REG_1787 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1787, X4, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X6_1 = X6;
DUMMY_REG_1787_1 = DUMMY_REG_1787;
X7_1 = X7;
}
...
assert((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 1)) && (X9_1 == 1)));
return 0;
}

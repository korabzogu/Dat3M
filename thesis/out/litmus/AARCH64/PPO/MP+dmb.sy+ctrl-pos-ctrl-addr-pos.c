...
<customTag1>DUMMY_REG_700</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_700</customTag>, memory_order_relaxed);//event.Load

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>X9</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_700_1 = DUMMY_REG_700;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;

...
int X5_1;
int X6_1;
int DUMMY_REG_1214_1;
int X7_1;
int DUMMY_REG_1215_1;
int X0_2;
int X1_2;
...
<customTag1>DUMMY_REG_1214</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1214</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1215</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1215</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_1214_1 = DUMMY_REG_1214;
X7_1 = X7;
DUMMY_REG_1215_1 = DUMMY_REG_1215;
}

...
DUMMY_REG_1429 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1429, X7, memory_order_relaxed );//event.Store

X9 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1429_1 = DUMMY_REG_1429;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

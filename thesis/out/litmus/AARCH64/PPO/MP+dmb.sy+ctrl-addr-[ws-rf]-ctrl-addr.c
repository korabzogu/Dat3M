...
atomic_store_explicit(&<customTag1>DUMMY_REG_1601</customTag>, <customTag1>X5</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1602</customTag>, memory_order_relaxed);//event.Load

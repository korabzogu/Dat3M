...
DUMMY_REG_1181 = (mem3 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1181, X6, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1181_1 = DUMMY_REG_1181;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(!((((((a == 2) && (x == 1)) && (y == 1)) && (X0_1 == 1)) && (X8_1 == 2)) && (X9_1 == 0)));
return 0;
}

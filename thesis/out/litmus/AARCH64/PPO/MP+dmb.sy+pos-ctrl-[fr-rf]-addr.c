...
<customTag1>DUMMY_REG_994</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_994</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_994_1 = DUMMY_REG_994;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(((((((((x == 1) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

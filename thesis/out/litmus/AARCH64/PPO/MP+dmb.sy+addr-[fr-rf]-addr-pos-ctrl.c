...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_421</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_422</customTag>, memory_order_relaxed);//event.Load

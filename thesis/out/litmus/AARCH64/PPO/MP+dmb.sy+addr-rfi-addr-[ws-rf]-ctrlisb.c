...
atomic_store_explicit(&DUMMY_REG_583, X3, memory_order_relaxed );//event.Store
...
atomic_store_explicit(&DUMMY_REG_584, X7, memory_order_relaxed );//event.Store
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_583_1 = DUMMY_REG_583;
DUMMY_REG_584_1 = DUMMY_REG_584;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;

...
DUMMY_REG_1432 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1432, X5, memory_order_relaxed );//event.Store

X7 = 2;//event.Local

atomic_store_explicit(&mem3, X7, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_1432_1 = DUMMY_REG_1432;
X5_1 = X5;
X7_1 = X7;
}

...
DUMMY_REG_1907 = (mem0 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1907, X5, memory_order_relaxed );//event.Store

X7 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
DUMMY_REG_1907_1 = DUMMY_REG_1907;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;

...
int X3_1;
int X4_1;
int DUMMY_REG_1355_1;
int X5_1;
int DUMMY_REG_1356_1;
int X6_1;
int X7_1;
atomic_int mem0;
atomic_int mem1;
...
DUMMY_REG_1355 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1355, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1356 = (mem3 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1356, X7, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1355_1 = DUMMY_REG_1355;
X5_1 = X5;
DUMMY_REG_1356_1 = DUMMY_REG_1356;
X6_1 = X6;
X7_1 = X7;
}

...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_989</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_990</customTag>, memory_order_relaxed);//event.Load

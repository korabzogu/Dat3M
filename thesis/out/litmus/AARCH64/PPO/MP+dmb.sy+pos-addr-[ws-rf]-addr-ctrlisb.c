...
int X2_1;
int X3_1;
int DUMMY_REG_1442_1;
int X4_1;
int DUMMY_REG_1443_1;
int X5_1;
int X6_1;
int X7_1;
int X0_2;
...
<customTag1>DUMMY_REG_1442</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1442</customTag>, <customTag1>X4</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1443</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1443</customTag>, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1442_1 = DUMMY_REG_1442;
X4_1 = X4;
DUMMY_REG_1443_1 = DUMMY_REG_1443;
X6_1 = X6;
X7_1 = X7;
}

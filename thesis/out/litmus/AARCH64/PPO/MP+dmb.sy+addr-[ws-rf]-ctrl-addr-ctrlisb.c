...
<customTag1>DUMMY_REG_444</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_444</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_445</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_445</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_444_1 = DUMMY_REG_444;
DUMMY_REG_445_1 = DUMMY_REG_445;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
X3_1 = X3;
...
assert(((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 2)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

...
DUMMY_REG_1048 = (mem2/* Address */ + X2) /* IEXPRBIN */;//event.Local
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1048_1 = DUMMY_REG_1048;
X5_1 = X5;
X6_1 = X6;
}
...
assert(((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 0)) && (X8_1 == 0)) && (X9_1 == 1)));
return 0;
}

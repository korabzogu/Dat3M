...
int X8_1;
int X9_1;
int DUMMY_REG_1912_1;
int DUMMY_REG_1911_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
<customTag1>DUMMY_REG_1911</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1911</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1912</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1912</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1912_1 = DUMMY_REG_1912;
DUMMY_REG_1911_1 = DUMMY_REG_1911;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
X3_1 = X3;

...
<customTag1>DUMMY_REG_160</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_160</customTag>, memory_order_relaxed);//event.Load
...
assert(!(((((((a == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 0)) && (<customAssertionTag1>X6</customAssertionTag> == 1)) && (<customAssertionTag1>X8</customAssertionTag> == 0)));
return 0;
}

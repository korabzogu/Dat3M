...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_119</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_120</customTag>, memory_order_relaxed);//event.Load

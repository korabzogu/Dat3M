...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_924</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_925</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_926</customTag>, memory_order_relaxed);//event.Load

...
DUMMY_REG_636 = (mem0 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_636, X6, memory_order_relaxed );//event.Store
...
assert(((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 0)) && (X4_1 == 1)) && (X8_1 == 1)) && (X9_1 == 1)));
return 0;
}

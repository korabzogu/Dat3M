...
int X8_1;
int X9_1;
int DUMMY_REG_1481_1;
int DUMMY_REG_1482_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
<customTag1>DUMMY_REG_1481</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1481</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1482</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1482</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1481_1 = DUMMY_REG_1481;
DUMMY_REG_1482_1 = DUMMY_REG_1482;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(!(((((((a == 2) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 2)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

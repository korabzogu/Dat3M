...
DUMMY_REG_1741 = (mem3 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1741, X6, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1741_1 = DUMMY_REG_1741;
X6_1 = X6;
}
...
assert(((((((((a == 2) && (x == 1)) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X4_1 == 1)) && (X8_1 == 2)) && (X9_1 == 0)));
return 0;
}

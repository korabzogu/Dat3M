...
<customTag1>DUMMY_REG_995</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_995</customTag>, memory_order_relaxed);//event.Load

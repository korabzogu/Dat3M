...
<customTag1>DUMMY_REG_2120</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2120</customTag>, memory_order_relaxed);//event.Load
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_2120_1 = DUMMY_REG_2120;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

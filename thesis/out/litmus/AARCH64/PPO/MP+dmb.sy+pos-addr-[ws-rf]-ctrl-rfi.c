...
DUMMY_REG_1698 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1698, X4, memory_order_relaxed );//event.Store
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1698_1 = DUMMY_REG_1698;
X6_1 = X6;
X7_1 = X7;
}
...
assert((((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 2)) && (X9_1 == 1)));
return 0;
}

...
X4 = atomic_load_explicit(&mem3, memory_order_relaxed);//event.Load
...
DUMMY_REG_1016 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1016, X8, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X6_1 = X6;
DUMMY_REG_1016_1 = DUMMY_REG_1016;
X7_1 = X7;
}
...
assert((((((((a == 1) && (x == 2)) && (y == 1)) && (X0_1 == 1)) && (X4_1 == 0)) && (X6_1 == 1)) && (X10_1 == 1)));
return 0;
}

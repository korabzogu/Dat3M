...
<customTag1>DUMMY_REG_1758</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1758</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1758_1 = DUMMY_REG_1758;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;

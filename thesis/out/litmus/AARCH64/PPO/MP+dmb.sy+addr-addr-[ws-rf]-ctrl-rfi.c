...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2035</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_2036</customTag> = <customTag1>X6</customTag>;

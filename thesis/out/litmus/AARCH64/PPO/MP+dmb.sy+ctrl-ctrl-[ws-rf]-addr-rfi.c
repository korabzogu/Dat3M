...
atomic_store_explicit(&mem3, X4, memory_order_relaxed );//event.Store
...
DUMMY_REG_1769 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1769, X8, memory_order_relaxed );//event.Store

X10 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1769_1 = DUMMY_REG_1769;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
...
assert(((((((a == 2) && (x == 2)) && (y == 1)) && (X0_1 == 1)) && (X6_1 == 2)) && (X10_1 == 1)));
return 0;
}

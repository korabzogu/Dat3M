...
int X0_1;
int X1_1;
int DUMMY_REG_1561_1;
int X2_1;
int DUMMY_REG_1562_1;
int X3_1;
int X4_1;
int X5_1;
int X6_1;
...
<customTag1>DUMMY_REG_1561</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1561</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1562</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1562</customTag>, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1561_1 = DUMMY_REG_1561;
X2_1 = X2;
DUMMY_REG_1562_1 = DUMMY_REG_1562;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;

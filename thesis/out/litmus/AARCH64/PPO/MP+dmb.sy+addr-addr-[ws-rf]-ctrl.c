...
int X4_1;
int X5_1;
int DUMMY_REG_1566_1;
int X6_1;
int X7_1;
int DUMMY_REG_1567_1;
int X0_2;
int X1_2;
atomic_int mem0;
atomic_int mem1;
...
<customTag1>DUMMY_REG_1566</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1566</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1567</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1567</customTag>, <customTag1>X6</customTag>, memory_order_relaxed );//event.Store
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_1566_1 = DUMMY_REG_1566;
X6_1 = X6;
DUMMY_REG_1567_1 = DUMMY_REG_1567;
}

...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_540</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_541</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store

...
<customTag1>DUMMY_REG_540</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_540</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_541</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_541</customTag> = <customTag1>X7</customTag>;
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_541_1 = DUMMY_REG_541;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_540_1 = DUMMY_REG_540;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;

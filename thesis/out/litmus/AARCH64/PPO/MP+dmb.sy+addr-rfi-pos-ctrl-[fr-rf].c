...
DUMMY_REG_1523 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1523, X3, memory_order_relaxed );//event.Store
...
X5_1 = X5;
X6_1 = X6;
DUMMY_REG_1523_1 = DUMMY_REG_1523;
X7_1 = X7;
}

...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1996</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1997</customTag>, memory_order_relaxed);//event.Load

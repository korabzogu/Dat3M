...
int X10_1;
int X0_1;
int DUMMY_REG_1791_1;
int X1_1;
int DUMMY_REG_1792_1;
int X2_1;
int X3_1;
int X4_1;
int X5_1;
...
DUMMY_REG_1791 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1791, X4, memory_order_relaxed );//event.Store
...
DUMMY_REG_1792 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1792, X8, memory_order_relaxed );//event.Store
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1791_1 = DUMMY_REG_1791;
DUMMY_REG_1792_1 = DUMMY_REG_1792;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;
...
assert(!(((((((x == 2) && (y == 2)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 2)) && (X6_1 == 1)) && (X10_1 == 1)));
return 0;
}

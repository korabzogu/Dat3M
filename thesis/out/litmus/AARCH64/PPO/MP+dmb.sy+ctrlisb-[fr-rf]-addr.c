...
<customTag1>DUMMY_REG_730</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_730</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_730_1 = DUMMY_REG_730;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(!(((((((x == 1) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 0)) && (<customAssertionTag1>X4</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 0)));
return 0;
}

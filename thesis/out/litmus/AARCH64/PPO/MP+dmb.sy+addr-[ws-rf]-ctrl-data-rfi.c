...
DUMMY_REG_2040 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2040, X3, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_2040_1 = DUMMY_REG_2040;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(!((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X5_1 == 2)) && (X10_1 == 1)));
return 0;
}

...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_671</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_672</customTag>, memory_order_relaxed);//event.Load

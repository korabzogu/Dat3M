...
DUMMY_REG_1205 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1205, X4, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1205_1 = DUMMY_REG_1205;
X8_1 = X8;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X7_1 == 2)) && (X8_1 == 0)));
return 0;
}

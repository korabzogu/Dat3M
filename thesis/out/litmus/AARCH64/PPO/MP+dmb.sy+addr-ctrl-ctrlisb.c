...
<customTag1>DUMMY_REG_1984</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1984</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_1984_1 = DUMMY_REG_1984;
X7_1 = X7;
}

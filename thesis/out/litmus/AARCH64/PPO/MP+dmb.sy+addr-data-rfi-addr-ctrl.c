...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_591</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_592</customTag>, memory_order_relaxed);//event.Load

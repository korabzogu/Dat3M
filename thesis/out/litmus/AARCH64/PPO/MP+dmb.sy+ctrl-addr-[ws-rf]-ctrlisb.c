...
DUMMY_REG_1393 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1393, X5, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1393_1 = DUMMY_REG_1393;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(((((((a == 2) && (x == 1)) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 2)) && (X8_1 == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_1357</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1357</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X6_1 = X6;
DUMMY_REG_1357_1 = DUMMY_REG_1357;
X7_1 = X7;
}

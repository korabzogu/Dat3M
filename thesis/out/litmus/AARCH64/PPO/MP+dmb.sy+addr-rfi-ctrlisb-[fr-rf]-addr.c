...
<customTag1>DUMMY_REG_1032</customTag> = <customTag1>X3</customTag>;
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1033</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1067</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1068</customTag>, memory_order_relaxed);//event.Load

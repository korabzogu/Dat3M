...
<customTag1>DUMMY_REG_2070</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2070</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_2070_1 = DUMMY_REG_2070;
X8_1 = X8;
X9_1 = X9;
X0_1 = X0;
X2_1 = X2;

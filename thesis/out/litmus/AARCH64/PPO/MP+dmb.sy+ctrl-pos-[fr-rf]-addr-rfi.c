...
DUMMY_REG_2045 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2045, X7, memory_order_relaxed );//event.Store
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_2045_1 = DUMMY_REG_2045;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;
...
assert(((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 0)) && (X4_1 == 0)) && (X5_1 == 1)) && (X9_1 == 1)));
return 0;
}

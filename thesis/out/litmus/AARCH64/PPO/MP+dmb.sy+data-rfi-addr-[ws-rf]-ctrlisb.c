...
DUMMY_REG_2124 = (mem3 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2124, X6, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2124_1 = DUMMY_REG_2124;
X4_1 = X4;
X5_1 = X5;
X6_1 = X6;
}

...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_434</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_435</customTag>, memory_order_relaxed);//event.Load

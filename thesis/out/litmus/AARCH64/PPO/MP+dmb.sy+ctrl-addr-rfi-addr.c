...
atomic_store_explicit(&<customTag1>DUMMY_REG_865</customTag>, <customTag1>X5</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_866</customTag>, memory_order_relaxed);//event.Load

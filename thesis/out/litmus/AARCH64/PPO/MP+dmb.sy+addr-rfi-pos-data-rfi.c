...
DUMMY_REG_1065 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1065, X3, memory_order_relaxed );//event.Store
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_1065_1 = DUMMY_REG_1065;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 1)) && (X9_1 == 1)));
return 0;
}

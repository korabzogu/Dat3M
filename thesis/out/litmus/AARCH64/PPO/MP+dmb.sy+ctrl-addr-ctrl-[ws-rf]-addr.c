...
<customTag1>DUMMY_REG_494</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_494</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_495</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_495</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_495_1 = DUMMY_REG_495;
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_494_1 = DUMMY_REG_494;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}

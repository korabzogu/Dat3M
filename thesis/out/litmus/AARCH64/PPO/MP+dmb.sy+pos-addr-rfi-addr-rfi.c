...
int X8_1;
int X9_1;
int DUMMY_REG_1691_1;
int X10_1;
int X0_1;
int DUMMY_REG_1692_1;
int X1_1;
int X2_1;
int X3_1;
int X4_1;
...
DUMMY_REG_1691 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1691, X4, memory_order_relaxed );//event.Store
...
DUMMY_REG_1692 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1692, X8, memory_order_relaxed );//event.Store

X10 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1691_1 = DUMMY_REG_1691;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1692_1 = DUMMY_REG_1692;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;
...
assert((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 1)) && (X10_1 == 1)));
return 0;
}

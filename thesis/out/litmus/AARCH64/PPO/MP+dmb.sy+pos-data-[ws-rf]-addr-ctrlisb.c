...
<customTag1>DUMMY_REG_1534</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1534</customTag>, memory_order_relaxed);//event.Load
...
X6_1 = X6;
X7_1 = X7;
DUMMY_REG_1534_1 = DUMMY_REG_1534;
}

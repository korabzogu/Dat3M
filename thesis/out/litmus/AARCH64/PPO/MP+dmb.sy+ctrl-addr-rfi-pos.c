...
DUMMY_REG_1786 = (mem0 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1786, X5, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1786_1 = DUMMY_REG_1786;
X7_1 = X7;
}
...
assert((((((x == 2) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 1)) && (X8_1 == 1)));
return 0;
}

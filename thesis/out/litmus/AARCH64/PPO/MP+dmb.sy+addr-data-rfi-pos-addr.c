...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_815</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_816</customTag>, memory_order_relaxed);//event.Load

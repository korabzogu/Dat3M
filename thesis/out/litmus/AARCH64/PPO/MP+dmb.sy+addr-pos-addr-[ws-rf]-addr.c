...
int X8_1;
int X9_1;
int DUMMY_REG_2091_1;
int DUMMY_REG_2090_1;
int X10_1;
int X12_1;
int X0_1;
int DUMMY_REG_2089_1;
int X1_1;
int X11_1;
int X2_1;
int X3_1;
...
<customTag1>DUMMY_REG_2089</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2089</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_2090</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_2090</customTag> = <customTag1>X7</customTag>;
...
<customTag1>DUMMY_REG_2091</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2091</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_2091_1 = DUMMY_REG_2091;
DUMMY_REG_2090_1 = DUMMY_REG_2090;
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_2089_1 = DUMMY_REG_2089;
X11_1 = X11;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

...
DUMMY_REG_826 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_826, X7, memory_order_relaxed );//event.Store
...
assert((((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X4_1 == 1)) && (X5_1 == 2)) && (X9_1 == 1)));
return 0;
}

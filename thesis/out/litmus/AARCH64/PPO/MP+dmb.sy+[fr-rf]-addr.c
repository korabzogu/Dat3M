...
<customTag1>DUMMY_REG_355</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_355</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_355_1 = DUMMY_REG_355;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
...
assert((((((x == 1) && (y == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 2)) && (<customAssertionTag1>X4</customAssertionTag> == 0)));
return 0;
}

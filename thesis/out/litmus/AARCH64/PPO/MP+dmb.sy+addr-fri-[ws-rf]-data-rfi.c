...
<customTag1>DUMMY_REG_1012</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1012</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1012_1 = DUMMY_REG_1012;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;

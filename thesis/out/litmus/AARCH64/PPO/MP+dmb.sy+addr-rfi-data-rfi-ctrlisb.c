...
DUMMY_REG_1541 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1541, X3, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1541_1 = DUMMY_REG_1541;
X5_1 = X5;
X6_1 = X6;
}

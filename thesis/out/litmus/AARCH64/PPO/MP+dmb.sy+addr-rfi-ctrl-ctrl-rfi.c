...
DUMMY_REG_2128 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2128, X3, memory_order_relaxed );//event.Store
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_2128_1 = DUMMY_REG_2128;
X6_1 = X6;
}

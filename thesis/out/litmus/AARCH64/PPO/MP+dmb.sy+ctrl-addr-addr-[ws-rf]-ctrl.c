...
int X8_1;
int X9_1;
int DUMMY_REG_1846_1;
int DUMMY_REG_1847_1;
int X10_1;
int X12_1;
int X0_1;
int X1_1;
...
<customTag1>DUMMY_REG_1846</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1846</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1847</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1847</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1846_1 = DUMMY_REG_1846;
DUMMY_REG_1847_1 = DUMMY_REG_1847;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
...
assert(!((((((b == 2) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 2)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1846</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1847</customTag> = <customTag1>X8</customTag>;

...
DUMMY_REG_501 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_501, X7, memory_order_relaxed );//event.Store

X9 = atomic_load_explicit(&mem0, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_501_1 = DUMMY_REG_501;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 0)) && (X5_1 == 1)) && (X9_1 == 1)));
return 0;
}

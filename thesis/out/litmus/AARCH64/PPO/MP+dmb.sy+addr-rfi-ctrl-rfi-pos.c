...
DUMMY_REG_1094 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1094, X3, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1094_1 = DUMMY_REG_1094;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X8_1 == 1)) && (X9_1 == 1)));
return 0;
}

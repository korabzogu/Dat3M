...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_929</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_930</customTag>, memory_order_relaxed);//event.Load

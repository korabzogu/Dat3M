...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1406</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1407</customTag>, memory_order_relaxed);//event.Load

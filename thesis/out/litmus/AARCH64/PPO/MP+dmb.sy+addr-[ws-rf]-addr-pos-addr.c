...
int X11_1;
int X2_1;
int DUMMY_REG_2058_1;
int X3_1;
int X4_1;
int X5_1;
int DUMMY_REG_2059_1;
int X6_1;
int X7_1;
int X0_2;
int X1_2;
...
<customTag1>DUMMY_REG_2058</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_2058</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_2059</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2059</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_2060</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2060</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_2060_1 = DUMMY_REG_2060;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
DUMMY_REG_2058_1 = DUMMY_REG_2058;
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_2059_1 = DUMMY_REG_2059;
X6_1 = X6;
X7_1 = X7;
}

...
<customTag1>DUMMY_REG_596</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_596</customTag>, memory_order_relaxed);//event.Load

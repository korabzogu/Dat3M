...
X3 = atomic_load_explicit(&mem2/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

X5 = (X3 ^ X3) /* IEXPRBIN */;//event.Local

X6 = 1;//event.Local

DUMMY_REG_2006 = (mem3/* Address */ + X5) /* IEXPRBIN */;//event.Local

DUMMY_REG_2006 = X6;

X8 = atomic_load_explicit(&mem3/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X5_1 = X5;
X6_1 = X6;
DUMMY_REG_2006_1 = DUMMY_REG_2006;
}
...
assert((((((((a == 1) && (x == 1)) && (y == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X8_1 == 1)) && (X9_1 == 0)));
return 0;
}

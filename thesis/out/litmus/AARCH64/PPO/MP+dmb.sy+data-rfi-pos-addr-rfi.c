...
DUMMY_REG_1245 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1245, X7, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_1245_1 = DUMMY_REG_1245;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

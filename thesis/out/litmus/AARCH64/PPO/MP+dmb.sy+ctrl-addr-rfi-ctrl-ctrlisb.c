...
DUMMY_REG_983 = (mem3/* Address */ + X4) /* IEXPRBIN */;//event.Local
...
X8 = atomic_load_explicit(&mem4/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

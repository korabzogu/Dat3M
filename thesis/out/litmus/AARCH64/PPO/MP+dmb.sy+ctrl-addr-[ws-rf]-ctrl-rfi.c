...
DUMMY_REG_1287 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1287, X5, memory_order_relaxed );//event.Store
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_1287_1 = DUMMY_REG_1287;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
}

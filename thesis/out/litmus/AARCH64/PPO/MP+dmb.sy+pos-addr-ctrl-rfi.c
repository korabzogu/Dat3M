...
<customTag1>DUMMY_REG_210</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_210</customTag>, memory_order_relaxed);//event.Load

...
DUMMY_REG_2003 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2003, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_2004 = (mem3 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2004, X7, memory_order_relaxed );//event.Store

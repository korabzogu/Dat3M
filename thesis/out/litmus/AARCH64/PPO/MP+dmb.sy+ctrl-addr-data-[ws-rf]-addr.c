...
int X4_1;
int X5_1;
int DUMMY_REG_1532_1;
int X6_1;
int DUMMY_REG_1533_1;
int X7_1;
int X0_2;
int X1_2;
atomic_int mem0;
...
<customTag1>DUMMY_REG_1532</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1532</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1533</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1533</customTag>, memory_order_relaxed);//event.Load
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1532_1 = DUMMY_REG_1532;
DUMMY_REG_1533_1 = DUMMY_REG_1533;
X7_1 = X7;
}

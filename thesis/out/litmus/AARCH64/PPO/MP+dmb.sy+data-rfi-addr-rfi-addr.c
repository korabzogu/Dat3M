...
<customTag1>DUMMY_REG_1689</customTag> = <customTag1>X6</customTag>;
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1690</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

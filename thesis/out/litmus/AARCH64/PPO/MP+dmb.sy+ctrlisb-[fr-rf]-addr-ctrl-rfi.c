...
<customTag1>DUMMY_REG_1687</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1687</customTag>, memory_order_relaxed);//event.Load
...
X5_1 = X5;
X6_1 = X6;
DUMMY_REG_1687_1 = DUMMY_REG_1687;
}

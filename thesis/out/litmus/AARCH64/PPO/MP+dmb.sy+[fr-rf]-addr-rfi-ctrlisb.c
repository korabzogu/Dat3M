...
DUMMY_REG_1988 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1988, X4, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1988_1 = DUMMY_REG_1988;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
...
assert((((((((x == 1) && (y == 2)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 2)) && (X6_1 == 1)) && (X7_1 == 0)));
return 0;
}

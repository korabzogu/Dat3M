...
DUMMY_REG_250 = (mem0 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_250, X6, memory_order_relaxed );//event.Store
...
assert(((((((x == 2) && (y == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X4_1 == 2)) && (X8_1 == 1)));
return 0;
}

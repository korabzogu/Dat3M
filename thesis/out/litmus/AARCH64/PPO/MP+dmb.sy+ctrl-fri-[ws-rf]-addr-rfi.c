...
DUMMY_REG_1279 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1279, X7, memory_order_relaxed );//event.Store
...
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1279_1 = DUMMY_REG_1279;
X6_1 = X6;
X7_1 = X7;
}
...
assert((((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 0)) && (X5_1 == 2)) && (X9_1 == 1)));
return 0;
}

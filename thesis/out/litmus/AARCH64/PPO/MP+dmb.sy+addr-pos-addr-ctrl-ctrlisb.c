...
int X2_1;
int X3_1;
int DUMMY_REG_1112_1;
int X4_1;
int DUMMY_REG_1113_1;
int X5_1;
int X6_1;
int X7_1;
...
<customTag1>DUMMY_REG_1112</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1112</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1113</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1113</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1112_1 = DUMMY_REG_1112;
DUMMY_REG_1113_1 = DUMMY_REG_1113;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

...
DUMMY_REG_1615 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1615, X4, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1615_1 = DUMMY_REG_1615;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;

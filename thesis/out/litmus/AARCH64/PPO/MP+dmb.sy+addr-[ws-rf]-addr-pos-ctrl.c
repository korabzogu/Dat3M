...
atomic_store_explicit(&<customTag1>DUMMY_REG_2068</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2069</customTag>, memory_order_relaxed);//event.Load

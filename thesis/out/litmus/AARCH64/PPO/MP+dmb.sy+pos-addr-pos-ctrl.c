...
<customTag1>DUMMY_REG_1398</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1398</customTag>, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1398_1 = DUMMY_REG_1398;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
}

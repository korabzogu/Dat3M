...
<customTag1>DUMMY_REG_1401</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1401</customTag>, memory_order_relaxed);//event.Load
...
X5_1 = X5;
X6_1 = X6;
DUMMY_REG_1401_1 = DUMMY_REG_1401;
X7_1 = X7;
}

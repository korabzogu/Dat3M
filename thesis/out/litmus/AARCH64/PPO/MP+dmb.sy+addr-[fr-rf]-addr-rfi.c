...
<customTag1>DUMMY_REG_483</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_483</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_484</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_484</customTag>, <customTag1>X7</customTag>, memory_order_relaxed );//event.Store
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_484_1 = DUMMY_REG_484;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_483_1 = DUMMY_REG_483;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 1)));
return 0;
}

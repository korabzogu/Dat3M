...
int X8_1;
int X9_1;
int DUMMY_REG_1260_1;
int DUMMY_REG_1261_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
<customTag1>DUMMY_REG_1260</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1260</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1261</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1261</customTag>, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1260_1 = DUMMY_REG_1260;
DUMMY_REG_1261_1 = DUMMY_REG_1261;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;

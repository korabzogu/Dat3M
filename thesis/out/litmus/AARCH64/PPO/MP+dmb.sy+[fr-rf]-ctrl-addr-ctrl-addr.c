...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_765</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_766</customTag>, memory_order_relaxed);//event.Load

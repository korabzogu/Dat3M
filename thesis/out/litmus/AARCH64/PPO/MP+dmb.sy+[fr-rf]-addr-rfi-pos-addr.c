...
<customTag1>DUMMY_REG_1622</customTag> = <customTag1>X4</customTag>;
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1623</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
int X8_1;
int X9_1;
int DUMMY_REG_1063_1;
int DUMMY_REG_1064_1;
int X10_1;
int X0_1;
int X1_1;
int X2_1;
...
DUMMY_REG_1063 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1063, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1064 = (mem0 + X6) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1064, X7, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1063_1 = DUMMY_REG_1063;
DUMMY_REG_1064_1 = DUMMY_REG_1064;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(!(((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X9_1 == 1)) && (X10_1 == 1)));
return 0;
}

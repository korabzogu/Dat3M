...
<customTag1>DUMMY_REG_1974</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1974</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1975</customTag> = (<customTag1>X12</customTag> + <customTag1>X10</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1975</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1975_1 = DUMMY_REG_1975;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
DUMMY_REG_1974_1 = DUMMY_REG_1974;
X7_1 = X7;
}
...
assert((((((((b == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X11</customAssertionTag> == 0)));
return 0;
}

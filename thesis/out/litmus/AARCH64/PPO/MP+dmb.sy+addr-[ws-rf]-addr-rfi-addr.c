...
<customTag1>DUMMY_REG_1450</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_1451</customTag> = <customTag1>X7</customTag>;
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1452</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

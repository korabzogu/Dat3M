...
int X4_1;
int X5_1;
int DUMMY_REG_1412_1;
int X6_1;
int X7_1;
int DUMMY_REG_1413_1;
atomic_int mem0;
atomic_int mem1;
atomic_int mem2;
atomic_int mem3;
...
DUMMY_REG_1412 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1412, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1413 = (mem0 + X8) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1413, X9, memory_order_relaxed );//event.Store
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_1412_1 = DUMMY_REG_1412;
X6_1 = X6;
DUMMY_REG_1413_1 = DUMMY_REG_1413;
}
...
assert(((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X11_1 == 1)));
return 0;
}

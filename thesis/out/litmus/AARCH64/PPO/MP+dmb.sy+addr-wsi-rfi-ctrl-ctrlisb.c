...
DUMMY_REG_1772 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1772, X3, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1772_1 = DUMMY_REG_1772;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X6_1 == 2)) && (X9_1 == 0)));
return 0;
}

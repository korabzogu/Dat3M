...
DUMMY_REG_784 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_784, X3, memory_order_relaxed );//event.Store
...
assert(!((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X6_1 == 2)) && (X9_1 == 1)));
return 0;
}

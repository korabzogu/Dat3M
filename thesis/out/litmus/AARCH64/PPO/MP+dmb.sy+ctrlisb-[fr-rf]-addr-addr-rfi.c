...
<customTag1>X6</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1246</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1247</customTag> = <customTag1>X9</customTag>;

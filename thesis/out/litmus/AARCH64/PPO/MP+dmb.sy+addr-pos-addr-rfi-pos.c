...
<customTag1>DUMMY_REG_679</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_679</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_680</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_680</customTag> = <customTag1>X7</customTag>;
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_679_1 = DUMMY_REG_679;
X9_1 = X9;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_680_1 = DUMMY_REG_680;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
...
assert((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 1)));
return 0;
}

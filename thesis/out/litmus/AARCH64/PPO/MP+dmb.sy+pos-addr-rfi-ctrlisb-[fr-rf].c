...
DUMMY_REG_373 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_373, X4, memory_order_relaxed );//event.Store
...
assert(!((((((((x == 2) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 1)) && (X7_1 == 0)) && (X9_1 == 1)));
return 0;
}

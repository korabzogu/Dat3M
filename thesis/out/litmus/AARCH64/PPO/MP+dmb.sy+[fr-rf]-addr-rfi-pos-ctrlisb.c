...
DUMMY_REG_1425 = (mem2/* Address */ + X3) /* IEXPRBIN */;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1425_1 = DUMMY_REG_1425;
X8_1 = X8;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(((((((((x == 1) && (y == 2)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 2)) && (X6_1 == 1)) && (X7_1 == 1)) && (X8_1 == 0)));
return 0;
}

...
DUMMY_REG_1795 = (mem0/* Address */ + X4) /* IEXPRBIN */;//event.Local
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1795_1 = DUMMY_REG_1795;
X5_1 = X5;
X7_1 = X7;
}
...
assert((((((((x == 2) && (y == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X3_1 == 2)) && (X7_1 == 1)) && (X8_1 == 1)));
return 0;
}

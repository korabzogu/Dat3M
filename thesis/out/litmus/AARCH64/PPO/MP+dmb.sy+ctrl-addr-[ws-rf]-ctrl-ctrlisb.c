...
DUMMY_REG_945 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_945, X5, memory_order_relaxed );//event.Store
...
X8 = atomic_load_explicit(&mem4, memory_order_relaxed);//event.Load

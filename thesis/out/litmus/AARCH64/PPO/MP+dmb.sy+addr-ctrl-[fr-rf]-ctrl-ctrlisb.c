...
<customTag1>DUMMY_REG_1826</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1826</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1826_1 = DUMMY_REG_1826;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert((((((((a == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

...
DUMMY_REG_1620 = (mem2/* Address */ + X2) /* IEXPRBIN */;//event.Local
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1620_1 = DUMMY_REG_1620;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}
...
assert(((((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 1)) && (X7_1 == 2)) && (X8_1 == 0)));
return 0;
}

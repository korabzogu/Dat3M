...
<customTag1>DUMMY_REG_440</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_440</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_441</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_441</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_440_1 = DUMMY_REG_440;
DUMMY_REG_441_1 = DUMMY_REG_441;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;

...
int X8_1;
int X9_1;
int DUMMY_REG_1705_1;
int DUMMY_REG_1706_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
<customTag1>DUMMY_REG_1705</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1705</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1706</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_1706</customTag> = <customTag1>X7</customTag>;
...
atomic_thread_fence(memory_order_seq_cst);
X9_1 = X9;
DUMMY_REG_1705_1 = DUMMY_REG_1705;
DUMMY_REG_1706_1 = DUMMY_REG_1706;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
...
assert(((((((a == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

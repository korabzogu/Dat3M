...
<customTag1>DUMMY_REG_2078</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2078</customTag>, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_2078_1 = DUMMY_REG_2078;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;

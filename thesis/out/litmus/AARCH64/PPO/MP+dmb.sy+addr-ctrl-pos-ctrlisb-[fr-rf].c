...
<customTag1>DUMMY_REG_1641</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1641</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1641_1 = DUMMY_REG_1641;
X5_1 = X5;
X7_1 = X7;
}

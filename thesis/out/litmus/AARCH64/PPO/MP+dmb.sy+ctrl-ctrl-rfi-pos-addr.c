...
<customTag1>DUMMY_REG_2113</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2113</customTag>, memory_order_relaxed);//event.Load
...
X0_1 = X0;
X2_1 = X2;
DUMMY_REG_2113_1 = DUMMY_REG_2113;
X4_1 = X4;
X6_1 = X6;
X7_1 = X7;
}

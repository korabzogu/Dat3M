...
DUMMY_REG_2038 = (mem3/* Address */ + X5) /* IEXPRBIN */;//event.Local
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_2038_1 = DUMMY_REG_2038;
X5_1 = X5;
X6_1 = X6;
}
...
assert(((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X4_1 == 2)) && (X8_1 == 1)) && (X9_1 == 0)));
return 0;
}

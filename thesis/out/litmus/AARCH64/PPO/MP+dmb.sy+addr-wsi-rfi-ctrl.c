...
DUMMY_REG_1383 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1383, X3, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1383_1 = DUMMY_REG_1383;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
...
assert(((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X6_1 == 2)) && (X7_1 == 0)));
return 0;
}

...
DUMMY_REG_1136 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1136, X4, memory_order_relaxed );//event.Store
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1136_1 = DUMMY_REG_1136;
X6_1 = X6;
X7_1 = X7;
}
...
assert((((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 2)) && (X9_1 == 0)));
return 0;
}

...
DUMMY_REG_2020 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_2020, X5, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X10_1 = X10;
DUMMY_REG_2020_1 = DUMMY_REG_2020;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(((((((a == 1) && (x == 2)) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 1)) && (X10_1 == 1)));
return 0;
}

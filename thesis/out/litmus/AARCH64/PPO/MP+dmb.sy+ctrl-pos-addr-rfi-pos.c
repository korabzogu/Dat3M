...
DUMMY_REG_415 = (mem0 + X5) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_415, X6, memory_order_relaxed );//event.Store
...
assert((((((x == 2) && (y == 1)) && (X0_1 == 1)) && (X8_1 == 1)) && (X9_1 == 1)));
return 0;
}

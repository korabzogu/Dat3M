...
<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1259</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>X5</customTag> = <customTag1>X7</customTag>;

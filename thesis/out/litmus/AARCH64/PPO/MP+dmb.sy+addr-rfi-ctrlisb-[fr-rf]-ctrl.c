...
DUMMY_REG_1869 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1869, X3, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1869_1 = DUMMY_REG_1869;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;

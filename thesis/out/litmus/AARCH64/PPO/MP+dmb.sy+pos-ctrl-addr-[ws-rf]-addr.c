...
int X8_1;
int X9_1;
int DUMMY_REG_1073_1;
int DUMMY_REG_1074_1;
int X10_1;
int X0_1;
int X1_1;
int X11_1;
...
<customTag1>DUMMY_REG_1073</customTag> = (<customTag1>X7</customTag> + <customTag1>X5</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_1073</customTag> = <customTag1>X6</customTag>;
...
<customTag1>DUMMY_REG_1074</customTag> = (<customTag1>X11</customTag> + <customTag1>X9</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1074</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1073_1 = DUMMY_REG_1073;
DUMMY_REG_1074_1 = DUMMY_REG_1074;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;

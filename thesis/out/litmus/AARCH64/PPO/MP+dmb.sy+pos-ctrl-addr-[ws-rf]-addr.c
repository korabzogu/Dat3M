...
atomic_store_explicit(&<customTag1>DUMMY_REG_1073</customTag>, <customTag1>X6</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X10</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1074</customTag>, memory_order_relaxed);//event.Load

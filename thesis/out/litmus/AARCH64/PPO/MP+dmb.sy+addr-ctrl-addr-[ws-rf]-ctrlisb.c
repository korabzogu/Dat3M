...
<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1320</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1321</customTag> = <customTag1>X8</customTag>;

...
int X2_1;
int X3_1;
int DUMMY_REG_1365_1;
int X4_1;
int DUMMY_REG_1366_1;
int X5_1;
int X6_1;
int X7_1;
int X0_2;
...
<customTag1>DUMMY_REG_1365</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1365</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1366</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1366</customTag>, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1365_1 = DUMMY_REG_1365;
DUMMY_REG_1366_1 = DUMMY_REG_1366;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

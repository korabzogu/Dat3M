...
<customTag1>DUMMY_REG_1752</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1752</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X5_1 = X5;
DUMMY_REG_1752_1 = DUMMY_REG_1752;
X6_1 = X6;
X7_1 = X7;
}

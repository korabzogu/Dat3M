...
<customTag1>DUMMY_REG_1373</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1373</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1373_1 = DUMMY_REG_1373;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
X7_1 = X7;
...
assert(((((((x == 2) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 1)));
return 0;
}

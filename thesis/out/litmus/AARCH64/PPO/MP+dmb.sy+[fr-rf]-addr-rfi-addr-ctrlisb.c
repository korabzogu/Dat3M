...
int X10_1;
int X0_1;
int DUMMY_REG_1230_1;
int X1_1;
int X11_1;
int DUMMY_REG_1231_1;
int X2_1;
int X3_1;
int X4_1;
int X5_1;
...
<customTag1>DUMMY_REG_1230</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1230</customTag>, <customTag1>X4</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1231</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X8</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1231</customTag>, memory_order_relaxed);//event.Load
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1230_1 = DUMMY_REG_1230;
DUMMY_REG_1231_1 = DUMMY_REG_1231;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;

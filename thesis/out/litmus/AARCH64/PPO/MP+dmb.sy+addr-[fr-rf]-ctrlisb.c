...
<customTag1>DUMMY_REG_2123</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_2123</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_2123_1 = DUMMY_REG_2123;
X5_1 = X5;
X6_1 = X6;
}
...
assert((((((((x == 1) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X3</customAssertionTag> == 0)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X6</customAssertionTag> == 0)));
return 0;
}

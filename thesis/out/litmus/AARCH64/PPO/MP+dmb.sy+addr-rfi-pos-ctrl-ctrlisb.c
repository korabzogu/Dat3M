...
DUMMY_REG_536 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_536, X3, memory_order_relaxed );//event.Store
...
assert(!(((((((x == 1) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X6_1 == 1)) && (X9_1 == 0)));
return 0;
}

...
int X10_1;
int X0_1;
int DUMMY_REG_1296_1;
int X1_1;
int DUMMY_REG_1297_1;
int X2_1;
int X3_1;
int X4_1;
int X5_1;
...
DUMMY_REG_1296 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1296, X3, memory_order_relaxed );//event.Store
...
DUMMY_REG_1297 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1297, X8, memory_order_relaxed );//event.Store
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1296_1 = DUMMY_REG_1296;
DUMMY_REG_1297_1 = DUMMY_REG_1297;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X6_1 = X6;
...
assert(((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X6_1 == 2)) && (X10_1 == 1)));
return 0;
}

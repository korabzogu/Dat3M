...
int X10_1;
int X0_1;
int DUMMY_REG_1098_1;
int X1_1;
int X11_1;
int DUMMY_REG_1099_1;
int X2_1;
int X3_1;
int X4_1;
int X5_1;
...
<customTag1>DUMMY_REG_1098</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X4</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1098</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1099</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_1099</customTag> = <customTag1>X7</customTag>;
...
X10_1 = X10;
X0_1 = X0;
DUMMY_REG_1098_1 = DUMMY_REG_1098;
DUMMY_REG_1099_1 = DUMMY_REG_1099;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
X6_1 = X6;
...
assert((((((((a == 2) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 2)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

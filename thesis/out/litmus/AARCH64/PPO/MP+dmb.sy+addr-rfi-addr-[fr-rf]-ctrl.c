...
int X3_1;
int X4_1;
int DUMMY_REG_1223_1;
int X5_1;
int DUMMY_REG_1224_1;
int X6_1;
int X7_1;
int X0_2;
int X1_2;
...
<customTag1>DUMMY_REG_1223</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>DUMMY_REG_1223</customTag> = <customTag1>X3</customTag>;
...
<customTag1>DUMMY_REG_1224</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1224</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1223_1 = DUMMY_REG_1223;
X5_1 = X5;
DUMMY_REG_1224_1 = DUMMY_REG_1224;
X6_1 = X6;
X7_1 = X7;
}
...
assert((((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X9</customAssertionTag> == 1)) && (<customAssertionTag1>X10</customAssertionTag> == 0)));
return 0;
}

...
atomic_store_explicit(&<customTag1>DUMMY_REG_1223</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1224</customTag>, memory_order_relaxed);//event.Load

...
DUMMY_REG_1527 = (mem2/* Address */ + X3) /* IEXPRBIN */;//event.Local
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1527_1 = DUMMY_REG_1527;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
...
assert(((((((((x == 1) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 1)) && (X7_1 == 2)) && (X8_1 == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_1483</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1483</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X0_1 = X0;
DUMMY_REG_1483_1 = DUMMY_REG_1483;
X2_1 = X2;
X3_1 = X3;
X5_1 = X5;
X7_1 = X7;
...
assert((((((x == 1) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 0)));
return 0;
}

...
int X2_1;
int X3_1;
int DUMMY_REG_1552_1;
int X4_1;
int DUMMY_REG_1553_1;
int X5_1;
int X6_1;
int X7_1;
int X0_2;
...
DUMMY_REG_1552 = (mem2 + X3) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1552, X4, memory_order_relaxed );//event.Store
...
DUMMY_REG_1553 = (mem0 + X7) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1553, X8, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1552_1 = DUMMY_REG_1552;
X4_1 = X4;
DUMMY_REG_1553_1 = DUMMY_REG_1553;
X6_1 = X6;
X7_1 = X7;
}
...
assert(!(((((((x == 2) && (y == 1)) && (z == 2)) && (X0_1 == 1)) && (X2_1 == 1)) && (X6_1 == 2)) && (X10_1 == 1)));
return 0;
}

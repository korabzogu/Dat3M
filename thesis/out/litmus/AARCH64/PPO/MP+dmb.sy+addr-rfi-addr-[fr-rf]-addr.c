...
atomic_store_explicit(&<customTag1>DUMMY_REG_869</customTag>, <customTag1>X3</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_870</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>X11</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_871</customTag>, memory_order_relaxed);//event.Load

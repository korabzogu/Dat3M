...
<customTag1>DUMMY_REG_1344</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1344</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
X2_1 = X2;
X4_1 = X4;
DUMMY_REG_1344_1 = DUMMY_REG_1344;
X5_1 = X5;
X7_1 = X7;
}
...
assert((((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 0)) && (<customAssertionTag1>X4</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

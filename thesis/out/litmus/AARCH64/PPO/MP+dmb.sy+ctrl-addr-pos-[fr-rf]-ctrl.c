...
<customTag1>DUMMY_REG_1535</customTag> = (<customTag1>X6</customTag> + <customTag1>X4</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1535</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
DUMMY_REG_1535_1 = DUMMY_REG_1535;
X8_1 = X8;
X9_1 = X9;
X0_1 = X0;
X2_1 = X2;
...
assert(((((((((a == 1) && (x == 1)) && (y == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X5</customAssertionTag> == 0)) && (<customAssertionTag1>X7</customAssertionTag> == 0)) && (<customAssertionTag1>X8</customAssertionTag> == 1)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

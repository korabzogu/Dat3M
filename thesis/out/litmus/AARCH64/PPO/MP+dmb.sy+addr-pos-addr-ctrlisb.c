...
<customTag1>DUMMY_REG_351</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_351</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_352</customTag> = (<customTag1>X8</customTag> + <customTag1>X6</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X7</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_352</customTag>, memory_order_relaxed);//event.Load
...
X9_1 = X9;
X0_1 = X0;
DUMMY_REG_352_1 = DUMMY_REG_352;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_351_1 = DUMMY_REG_351;
X5_1 = X5;
X6_1 = X6;
X7_1 = X7;
}

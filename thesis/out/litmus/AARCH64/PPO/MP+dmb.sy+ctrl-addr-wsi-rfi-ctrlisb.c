...
DUMMY_REG_1927 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1927, X5, memory_order_relaxed );//event.Store
...
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_1927_1 = DUMMY_REG_1927;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;

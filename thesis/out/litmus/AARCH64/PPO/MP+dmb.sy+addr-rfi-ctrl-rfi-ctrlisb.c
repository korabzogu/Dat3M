...
DUMMY_REG_1312 = (mem2 + X2) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1312, X3, memory_order_relaxed );//event.Store
...
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1312_1 = DUMMY_REG_1312;
X5_1 = X5;
X6_1 = X6;
}
...
assert(((((((((a == 1) && (x == 1)) && (y == 1)) && (z == 1)) && (X0_1 == 1)) && (X5_1 == 1)) && (X8_1 == 1)) && (X9_1 == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_1720</customTag> = <customTag1>X4</customTag>;
...
<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1721</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

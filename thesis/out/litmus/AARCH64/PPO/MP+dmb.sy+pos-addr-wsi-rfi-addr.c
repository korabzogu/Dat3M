...
int X4_1;
int X5_1;
int DUMMY_REG_1720_1;
int X6_1;
int X7_1;
int DUMMY_REG_1721_1;
atomic_int mem0;
atomic_int mem1;
atomic_int mem2;
void *func_0() {
...
<customTag1>DUMMY_REG_1720</customTag> = (<customTag1>X5</customTag> + <customTag1>X3</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1720</customTag>, <customTag1>X4</customTag>, memory_order_relaxed );//event.Store
...
<customTag1>DUMMY_REG_1721</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1721</customTag>, memory_order_relaxed);//event.Load
...
X3_1 = X3;
X4_1 = X4;
DUMMY_REG_1720_1 = DUMMY_REG_1720;
X6_1 = X6;
X7_1 = X7;
DUMMY_REG_1721_1 = DUMMY_REG_1721;
}
...
assert(!(((((((x == 1) && (y == 1)) && (z == 2)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X2</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 2)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

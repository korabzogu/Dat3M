...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1348</customTag>, memory_order_relaxed);//event.Load
...
atomic_store_explicit(&<customTag1>DUMMY_REG_1349</customTag>, <customTag1>X9</customTag>, memory_order_relaxed );//event.Store

...
<customTag1>DUMMY_REG_326</customTag> = (<customTag1>X10</customTag> + <customTag1>X8</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X9</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_326</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
X9_1 = X9;
DUMMY_REG_326_1 = DUMMY_REG_326;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
X5_1 = X5;
...
assert(((((((((a == 2) && (x == 1)) && (y == 1)) && (z == 1)) && (<customAssertionTag1>X0</customAssertionTag> == 1)) && (<customAssertionTag1>X4</customAssertionTag> == 1)) && (<customAssertionTag1>X7</customAssertionTag> == 2)) && (<customAssertionTag1>X9</customAssertionTag> == 0)));
return 0;
}

...
<customTag1>DUMMY_REG_1189</customTag> = (<customTag1>X4</customTag> + <customTag1>X2</customTag>) /* IEXPRBIN */;//event.Local

<customTag1>X3</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1189</customTag>, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1190</customTag> = (<customTag1>X9</customTag> + <customTag1>X7</customTag>) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&<customTag1>DUMMY_REG_1190</customTag>, <customTag1>X8</customTag>, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1190_1 = DUMMY_REG_1190;
X10_1 = X10;
X0_1 = X0;
X11_1 = X11;
X2_1 = X2;
X3_1 = X3;
DUMMY_REG_1189_1 = DUMMY_REG_1189;
X5_1 = X5;
X7_1 = X7;
}

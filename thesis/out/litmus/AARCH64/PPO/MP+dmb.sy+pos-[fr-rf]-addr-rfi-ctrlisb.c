...
X3 = atomic_load_explicit(&mem1/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

X4 = (X3 ^ X3) /* IEXPRBIN */;//event.Local

X5 = 1;//event.Local

DUMMY_REG_1514 = (mem2/* Address */ + X4) /* IEXPRBIN */;//event.Local

DUMMY_REG_1514 = X5;

X7 = atomic_load_explicit(&mem2/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1514_1 = DUMMY_REG_1514;
X0_1 = X0;
X2_1 = X2;
X3_1 = X3;
X4_1 = X4;
...
assert(((((((((x == 1) && (y == 2)) && (z == 1)) && (X0_1 == 1)) && (X2_1 == 1)) && (X3_1 == 2)) && (X7_1 == 1)) && (X8_1 == 0)));
return 0;
}

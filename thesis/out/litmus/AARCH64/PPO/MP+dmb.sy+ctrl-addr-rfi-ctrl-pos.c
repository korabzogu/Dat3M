...
DUMMY_REG_1270 = (mem3 + X4) /* IEXPRBIN */;//event.Local

atomic_store_explicit(&DUMMY_REG_1270, X5, memory_order_relaxed );//event.Store
...
atomic_thread_fence(memory_order_seq_cst);
X8_1 = X8;
DUMMY_REG_1270_1 = DUMMY_REG_1270;
X10_1 = X10;
X0_1 = X0;
X2_1 = X2;
X4_1 = X4;
...
assert(!(((((((a == 1) && (x == 1)) && (y == 1)) && (X0_1 == 1)) && (X7_1 == 1)) && (X8_1 == 0)) && (X10_1 == 0)));
return 0;
}

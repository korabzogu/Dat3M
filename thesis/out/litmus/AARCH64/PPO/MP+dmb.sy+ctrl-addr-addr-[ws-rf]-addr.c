...
<customTag1>X5</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1862</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
<customTag1>DUMMY_REG_1863</customTag> = <customTag1>X8</customTag>;
...
<customTag1>X12</customTag> = atomic_load_explicit(&<customTag1>DUMMY_REG_1864</customTag>/*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load

...
X6 = atomic_load_explicit(&mem1/* Address *//*com.dat3m.dartagnan.program.Register*/, memory_order_relaxed);//event.Load
...
assert(((((((((((ok == 1) && (x == 2)) && (y == 2)) && (z == 2)) && (X2_0 == 1)) && (X6_0 == 0)) && (X2_1 == 1)) && (X6_1 == 0)) && (X2_2 == 1)) && (X6_2 == 0)));
return 0;
}

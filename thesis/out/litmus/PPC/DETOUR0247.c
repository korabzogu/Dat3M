...
r3 = atomic_load_explicit(&mem2, memory_order_relaxed);//event.Load

r5 = 1;//event.Local

atomic_store_explicit(&mem2, r5, memory_order_relaxed );//event.Store
...
atomic_store_explicit(&mem0, r7, memory_order_relaxed );//event.Store

...
atomic_store_explicit(&mem1, r4, memory_order_relaxed );//event.Store
...
atomic_store_explicit(&mem0, r4, memory_order_relaxed );//event.Store
...
assert(!((((((x == 2) && (y == 2)) && (z == 2)) && (r3_0 == 2)) && (r3_1 == 2)) && (r3_2 == 2)));
return 0;
}
